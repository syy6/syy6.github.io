...
], function (jQuery, System, User, utils, ODataWrapper, URI, OData) {
    "use strict";
    /* jslint nomen:true */
        ...
        this._setUserImage = function (oUser) {
            ...
            function isUserImageEnabled() {
                ...
                var oConfig = window["sap-ushell-config"],
                    vUserImageEnabled = jQuery.sap.getObject("renderers.fiori2.componentData.config.enableUserImage", undefined, oConfig);
