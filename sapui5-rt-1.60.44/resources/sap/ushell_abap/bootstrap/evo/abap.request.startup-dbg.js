sap.ui.define([
    ...
    "sap/ui2/srvc/utils"
], function (oUshellUtils, oAbapUtils /*, oUi2Utils*/) {
    'use strict';
    ...
    oStartupHandler.requestStartupConfig = function () {
        var oServerSideConfigStartup = jQuery.sap.getObject("sap-ushell-config.services.Container.adapter.config"); // do not create
    ...
    /**
     * Performs the compact start-up request (so=*&action=*&tm-compact=true).
     *
     * @param {Object} oStartupConfig
     *    Startup object, used to take cacheId and other parameters
    ...
    oStartupHandler.requestCompactTM = function (oStartupConfig, bNoOData) {
        ...
        return requestStartup("so=*&action=*&tm-compact=true", ["sap-language", "sap-client", "sap-ui2-cache-disable"], oStartupConfig).then(function (oResult) {
            ...
            jQuery.sap.log.error("compactTMPromise rejected: " + sError);
    ...
    /**
     * Performs the full start-up request (so=*&action=*).
     *
     * @param {Object} oStartupConfig
     *    Startup object, used to take cacheId and other parameters
     * @param {Boolean} bNoOData
    ...
    oStartupHandler.requestFullTM = function (oStartupConfig, bNoOData) {
        ...
        return requestStartup("so=*&action=*", ["sap-language", "sap-client", "sap-ui2-cache-disable"], oStartupConfig).then(function (oResult) {
            if (oResult) {
            ...
            jQuery.sap.log.error("navTargetDataPromise rejected: " + sError);
            return Promise.reject(sError);
        });
