...
sap.ui.define([
    ...
    function getServerConfigUrls () {
        var oConfig = jQuery.sap.getObject("sap-ushell-config.launchpadConfiguration.configurationFile"),
        ...
        if (typeof sHardcodedUrlOrParameterUrl !== "undefined") {
            ...
            var oWhitelist = jQuery.sap.getObject("sap-ushell-config.launchpadConfiguration.configurationFile.configurationFileFolderWhitelist");
