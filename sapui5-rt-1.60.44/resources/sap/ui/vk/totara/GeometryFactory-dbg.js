sap.ui.define([
	"jquery.sap.global", "./IndexCompressor"
], function(jQuery, IndexCompressor) {
    "use strict";
    ...
    GeometryFactory.getGeometryInfo = function(geometryHeader, geometryBufferUint8) {
        ...
        var info = {};
        info.isPolyline = bIsPolyline;
        info.isPositionQuantized = isPositionQuantized;
        info.data = {};
        info.data.indices = indices;
        info.data.points = points;
        info.data.normals = normals;
        info.data.uvs = uvs;
        info.id = geometryHeader.id;
