...
sap.ui.define([
	...
	ContentConnector.prototype._getContentManagerByClassName = function(className) {
		...
		this._assignDecryptionHandler([ contentManager ]);
		this._assignAuthorizationHandler([ contentManager ]);
		return contentManager;
	};
	 ...
	 *
	 * A callback function which can be implemennted by an application which will provide an authorization token
	 *
	 * @example <caption>A sample implementation of authorization handler</caption>
	 *
	 * ...
	 ...
	 * @function
	 * @param {string} url A content resource URL for the connection where authorization is required
	 * @return {promise} Promise object which will be resolved when authorization token is obtained. Resolve method receives an object with parameters access_bearer and access_token
	 * @public
	 */
	 ...
	 *
	 * @example <caption>A sample implementation and usage of the sap.ui.vk.DecryptionHandler interface with the {@link https://cdnjs.cloudflare.com/ajax/libs/asmCrypto/0.16.4/asmcrypto.js asmCrypto} library.</caption>
	 *
	 *   ...
