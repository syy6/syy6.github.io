...
sap.ui.define([
	...
	"sap/m/Title", "sap/m/SearchField", "sap/m/Toolbar", "sap/m/ToolbarLayoutData", "sap/m/ToolbarSpacer", "sap/m/Text", "sap/ui/core/Icon", "./ContentConnector", "./ViewStateManager"
], function(jQuery, library, Control, TreeTable, Column, JSONModel, ResizeHandler,
		Title, SearchField, Toolbar, ToolbarLayoutData, ToolbarSpacer, Text, Icon, ContentConnector, ViewStateManager) {
	"use strict";
	...
	var SceneTree = Control.extend("sap.ui.vk.SceneTree", /** @lends sap.ui.vk.SceneTree.prototype */ {
		metadata: {
			...
			properties: {
				title: {
					type: "string",
					defaultValue: sap.ui.vk.getResourceBundle().getText("SCENETREE_TITLE")
				},
				showTitle: {
					type: "boolean",
					defaultValue: true
	...
	var tooltipVisible = sap.ui.vk.getResourceBundle().getText("SCENETREE_VISIBILITYSTATEVISIBLE"),
		tooltipHidden = sap.ui.vk.getResourceBundle().getText("SCENETREE_VISIBILITYSTATEHIDDEN");
