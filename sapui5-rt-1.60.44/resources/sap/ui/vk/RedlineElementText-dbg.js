...
sap.ui.define([
	 ...
	 * @public
	 */
	RedlineElementText.prototype.render = function(renderManager) {
	...
	RedlineElementText.prototype.exportJSON = function() {
		return jQuery.extend(true, RedlineElement.prototype.exportJSON.call(this), {
			type: sap.ui.vk.Redline.ElementType.Text,
			version: 1,
			text: this.getText(),
			font: this.getFont(),
	...
	RedlineElementText.prototype.importJSON = function(json) {
		if (json.type === sap.ui.vk.Redline.ElementType.Text) {
			if (json.version === 1) {
	...
	RedlineElementText.prototype.exportSVG = function() {
		var element = document.createElementNS(sap.ui.vk.Redline.svgNamespace, "text");
