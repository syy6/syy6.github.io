...
sap.ui.define([
	...
	jQuery.sap.registerModuleShims({
		...
		"sap/ui/vk/ve/thirdparty/html2canvas": {
			exports: "html2canvas",
			amd: true
		},
		"sap/ui/vk/threejs/thirdparty/totara": {
			exports: "Totara",
			amd: true
		}
	});
	...
	/**
	 * Render mode for {@link sap.ui.vk.threejs.Viewport}.
	 * @enum {string}
	 * @readonly
	 * @public
	 */
	...
	sap.ui.vk.ContentResourceSourceTypeToCategoryMap = {
		...
		"jpeg": sap.ui.vk.ContentResourceSourceCategory["2D"],
