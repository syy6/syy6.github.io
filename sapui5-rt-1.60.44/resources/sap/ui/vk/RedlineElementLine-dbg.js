...
sap.ui.define([
	 ...
	 * @public
	 */
	RedlineElementLine.prototype.render = function(renderManager) {
	...
	RedlineElementLine.prototype.exportJSON = function() {
		return jQuery.extend(true, RedlineElement.prototype.exportJSON.call(this), {
			type: sap.ui.vk.Redline.ElementType.Line,
			version: 1,
	...
	RedlineElementLine.prototype.importJSON = function(json) {
		if (json.type === sap.ui.vk.Redline.ElementType.Line) {
			if (json.version === 1) {
	...
	RedlineElementLine.prototype.exportSVG = function() {
		var element = document.createElementNS(sap.ui.vk.Redline.svgNamespace, "line");
