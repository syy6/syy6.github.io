...
sap.ui.define([
    "jquery.sap.global", "../library", "../Material", "./thirdparty/three", "./Texture"
], function(jQuery, library, MaterialBase, threeJs, Texture) {
    "use strict";
    ...
    Material.prototype.getOpacity = function() {
        if (this._nativeMaterial.opacity) {
    ...
    Material.prototype.getTextureReflection = function() {
        if (this._nativeMaterial.envMap) {
            var texture = new sap.ui.vk.threejs.Texture();
