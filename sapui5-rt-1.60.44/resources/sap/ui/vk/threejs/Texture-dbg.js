...
sap.ui.define([
    "jquery.sap.global", "../Texture", "./thirdparty/three"
], function(jQuery, TextureBase, threeJs) {
    "use strict";
    ...
    Texture.prototype.setFilterMode = function(val) {
        if  (this._nativeTexture) {
            ...
            this._nativeTexture.minFilter = val === 1 ? THREE.NearestFilter : THREE.LinearMipMapLinearFilter;
        }
    };
