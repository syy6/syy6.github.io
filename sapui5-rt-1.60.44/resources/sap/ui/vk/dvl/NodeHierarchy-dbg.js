...
sap.ui.define([
	"jquery.sap.global", "../library", "../NodeHierarchy", "sap/ui/base/ObjectPool", "./BaseNodeProxy", "./NodeProxy", "./LayerProxy", "../Messages", "../DvlException"
], function(jQuery, library, NodeHierarchyBase, ObjectPool, BaseNodeProxy, NodeProxy, LayerProxy, Messages, DvlException) {
	"use strict";
	...
	*/
	...
	NodeHierarchy.prototype.removeNode = function(nodeRef) {
		...
		arrayOfNodeRefs.forEach(function(nodeRef) {
			...
			try {
				sap.ui.vk.dvl.checkResult(this._dvl.Scene.DeleteNode(this._dvlSceneRef, nodeRef));
			} catch (e) {
