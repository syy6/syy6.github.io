...
sap.ui.define([
	...
	"sap/base/Log"
], function(FilterField, CommonHelper, v4ODataModel, Log) {
	"use strict";
	...
	return {
			...
			changeHandler: {
				applyChange: function (oChange, oFilterBar, mPropertyBag) {
					...
					if (!oModel instanceof v4ODataModel){
						Log.error("Change can't be applied without a container having a Odata v4 model assigned");
						return false;
					}
		...
		"removeFilter": {
			changeHandler: {
				...
				completeChangeContent: function(oChange, oSpecificChangeInfo, mPropertyBag) {
					oChange.setContent({
						removedElement: oSpecificChangeInfo.content.removedElement
					});
				},
