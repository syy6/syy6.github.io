...
sap.ui.define([
	...
	FieldInfoBase.prototype.getTriggerHref = function() {
		throw new Error("sap.ui.mdc.base.FieldInfoBase: method getTriggerHref must be redefined");
	};
	...
	FieldInfoBase.prototype.open = function(oControl) {
		...
		if (!oParent) {
			throw new Error("sap.ui.mdc.base.FieldInfoBase: popover can not be open because the control is undefined");
		}
	...
	FieldInfoBase.prototype.getContent = function(fnGetAutoClosedControl) {
		throw new Error("sap.ui.mdc.base.FieldInfoBase: method getContent must be redefined");
	};
	/**
	...
	FieldInfoBase.prototype.getContentTitle = function() {
		throw new Error("sap.ui.mdc.base.FieldInfoBase: method getContentTitle must be redefined");
	};
