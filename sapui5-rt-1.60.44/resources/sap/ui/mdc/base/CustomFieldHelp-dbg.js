...
sap.ui.define([
	 ...
	 *
	 * @param {any} vKey selected key
	 * @param {string} sDescription selected description
	 * @param {object[]} aConditions selected coinditions
	 * @public
	 * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
	 */
	CustomFieldHelp.prototype.fireSelectEvent = function(vKey, sDescrioption, aConditions) {

		this.close();
		this.fireSelect({value: vKey, additionalValue: sDescrioption, conditions: aConditions});
