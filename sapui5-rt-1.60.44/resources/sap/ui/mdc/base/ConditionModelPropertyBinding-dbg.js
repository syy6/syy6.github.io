...
sap.ui.define([
	 ...
	 * Such code should use {@link sap.ui.mdc.base.ConditionModel#bindProperty ConditionModel#bindProperty} on the corresponding model instance instead.
	 *
	 * @param {sap.ui.mdc.base.ConditionModel} oModel Model instance that this binding is created for and that it belongs to
	 ...
	 *
	 * @alias sap.ui.mdc.base.ConditionModelPropertyBinding
	 * @extends sap.ui.model.json.JSONPropertyBinding
	 * @protected
	 * @since 1.60.0
	 */
	var ConditionModelPropertyBinding = JSONPropertyBinding.extend("sap.ui.mdc.base.ConditionModelPropertyBinding", {
