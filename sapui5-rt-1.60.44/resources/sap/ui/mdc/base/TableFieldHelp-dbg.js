...
sap.ui.define([
	 ...
	 * @private
	 * @since 1.54.0
	 * @deprecated Since version 1.0.0. Replaced by property <code>FieldValueHelp</code> with <code>noDialog<Code> property
	...
	var TableFieldHelp = FieldHelpBase.extend("sap.ui.mdc.base.TableFieldHelp", /** @lends sap.ui.mdc.base.TableFieldHelp.prototype */
	{
		metadata: {
			...
			properties: {
				 ...
				 *
				 * the function must have the parameter <code>vKey</code> of type <code>string</code> and
			...
			events: {
				 ...
				 * and fill the properties. In addition the <code>conditions</code> property of the <code>TableFieldHelp</code>
				 * must be set.
				 */
				itemSelect: {
					parameters: {
				 ...
				 * must be set.
				 *
				 * In addition the <code>conditions</code> property of the <code>TableFieldHelp</code>
				 * must be set.
				 */
				navigateToItem: {
					parameters: {
	...
	TableFieldHelp.prototype.open = function(bSuggestion) {
	...
	TableFieldHelp.prototype.navigate = function(iStep) {
		...
		if (this.hasListeners("navigateToItem")) {
			...
			if (oItem && oItem !== oSelectedItem) {
				...
				var vKey = _getKeyFromItem.call(this, oItem);
				var sText = _getTextFromItem.call(this, oItem);
				_setConditions.call(this, vKey, sText);
				...
				this.fireNavigate({value: sText, key: vKey});
			}
		}

	};

	TableFieldHelp.prototype.getTextForKey = function(vKey) {
	...
	function _handleItemPress(oEvent) {
		...
		if (bSelected) {
			if (this.hasListeners("itemSelect")) {
				...
				_setConditions.call(this, vKey, sText);
				this.close();
				this.fireSelect({value: sText, key: vKey, coditions: this.getConditions(), add: true});
			}
		}
...
//			}
	...
	function _updateSelection(vSelectedKey) {
	...
	function _setConditions(vKey, sDescription) {
