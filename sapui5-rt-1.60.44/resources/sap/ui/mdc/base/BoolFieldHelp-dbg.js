...
sap.ui.define([
	 ...
	 * @private
	 * @since 1.60.0
	 * @alias sap.ui.mdc.base.BoolFieldHelp
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel
	 */
	var BoolFieldHelp = FieldHelpBase.extend("sap.ui.mdc.base.BoolFieldHelp", /** @lends sap.ui.mdc.base.BoolFieldHelp.prototype */
	{
		metadata: {
			library: "sap.ui.mdc"
		}
...
//		delete this._oManagedObjectModel;
	...
	BoolFieldHelp.prototype.navigate = function(iStep) {
		...
		if (oItem) {
			...
			if (oItem !== oSelectedItem) {
				...
				this.fireNavigate({value: oItem.getTitle(), key: vKey});
			}
	...
	function _handleItemPress(oEvent) {
		...
		if (bSelected) {
			...
			this.setProperty("conditions", [oCondition], true); // do not invalidate whole FieldHelp
			this.close();
			this.fireSelect({value: oItem.getTitle(), key: vKey, conditions: [oCondition], add: true});
		}
	}
	...
	function _updateModel() {
		...
		if (this._oField) {
			...
			var oType = this._oField._getDataType();
