...
sap.ui.define(['sap/ui/core/XMLComposite', 'sap/m/Text', 'sap/m/Link', 'sap/m/Label'], function(XMLComposite, Text, Link, Label) {
	 ...
	 * @private
	 * @since 1.56.0
	 * @alias sap.ui.mdc.base.info.ContactDetails
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel
	 */
	var ContactDetails = XMLComposite.extend("sap.ui.mdc.base.info.ContactDetails", /** @lends sap.ui.mdc.base.info.ContactDetails.prototype */
		{
			metadata: {
				library: "sap.ui.mdc",
				...
				aggregations: {
					items: {
						type: "sap.ui.mdc.base.info.ContactDetailsItem",
						multiple: true,
						singularName: "item"
					}
				}
