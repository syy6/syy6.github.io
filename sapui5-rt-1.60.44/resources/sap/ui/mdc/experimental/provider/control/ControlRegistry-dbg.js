...
sap.ui.define([
	...
	"sap/ui/mdc/experimental/provider/control/DefaultKnowledgeBase",
	"sap/base/util/ObjectPath",
	"jquery.sap.global"
], function(Utils, ControlProvider, DefaultKnowledgeBase, ObjectPath, jQuery) {
	"use strict";
	...
	ControlRegistry.visitControl = function(oMetadata) {
		...
		var Provider = ObjectPath.get(sProviderClass || "");
