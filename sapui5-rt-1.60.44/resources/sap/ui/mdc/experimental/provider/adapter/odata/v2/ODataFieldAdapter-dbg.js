...
sap.ui.define([
	"sap/ui/mdc/experimental/provider/adapter/base/FieldAdapter",
	"sap/ui/mdc/experimental/provider/adapter/odata/v2/ODataBaseAdapter",
	"sap/ui/mdc/experimental/provider/adapter/AdapterFactory",
	"sap/ui/thirdparty/jquery"
], function(FieldAdapter, ODataBaseAdapter, Factory, jQuery) {
	"use strict";
	...
	ODataFieldAdapter.prototype._collectAnnotations = function(sAnnotationName) {
		...
		for ( var sAttr in oProperty) {
			...
			if (typeof sAnnotationName == "string" && sAnnotationName.length > 0 && sName.startsWith(sAnnotationName) && (typeof sAnnotationName == "string" && sAnnotationName.length > 0 && sName.endsWith(sAnnotationName))) {
	...
	ODataFieldAdapter.prototype.semanticObjectMapping = function() {
		var fnGetMapping = function(aSemanticObjectMappings) {
			if (!Array.isArray(aSemanticObjectMappings)) {
				return {};
			}
			var oResult = {};
