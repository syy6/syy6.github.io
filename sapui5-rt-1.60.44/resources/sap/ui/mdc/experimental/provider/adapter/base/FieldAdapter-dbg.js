...
sap.ui.define([
	...
	var FieldAdapter = BaseAdapter.extend("sap.ui.mdc.experimental.provider.adapter.base.FieldAdapter", {
		...
		constructor: function(oModel, sModelName, sContextName, Base) {
			...
			this.putProperty("semanticObject", this.semanticObject);
			this.putProperty("semanticObjectMapping", this.semanticObjectMapping);
			this.putProperty("parent", this.parent);

			/**
			 * Properties: - textAlign//??? convenient
			 */
		},
		...
		/**
		 * The default and additional semantic object(s) of the field.
		 *
		 * @return {object}
		 * @public
		 */
		...
		/**
		 * The default and additional semantic object mapping(s) of the field.
		 *
		 * @return {object}
		 * @public
		 */
	...
	FieldAdapter.ValueHelpParameter = {
		type: 2,// default fromTo
		from: "",
		to: ""
	};

	FieldAdapter.ValueHelpParameterType = {
		from: 1,
		fromTo: 2,
		to: 3,
		displayOnly: 4,
