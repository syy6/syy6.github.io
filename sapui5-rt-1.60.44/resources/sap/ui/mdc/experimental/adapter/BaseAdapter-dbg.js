...
sap.ui.define([
	 ...
	 * @returns {sap.ui.mdc.experimental.adapter.BaseAdapter} an instance of a context specific adapter
	 *
	 * @experimental Since 1.62
	 * @private
	 * @abstract
	 */
	var BaseAdapter = BaseObject.extend("sap.ui.mdc.experimental.adapter.meta.BaseAdapter", {
		/**
