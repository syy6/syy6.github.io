...
sap.ui.define([
	...
	"sap/m/library"
], function(library, Control, MicroChartLibrary, SmartMicroChartCommons, MobileLibrary) {
	"use strict";
	...
	SmartRadialMicroChart.prototype.addAriaLabelledBy = function (vAriaLabelledBy) {
		this.addAssociation("ariaLabelledBy", vAriaLabelledBy, true);
		this.getAggregation("_chart").addAriaLabelledBy(vAriaLabelledBy);
		return this;
	};

	SmartRadialMicroChart.prototype.removeAriaLabelledBy = function (vAriaLabelledBy) {
	...
	SmartRadialMicroChart.prototype.removeAllAriaLabelledBy = function () {
	...
	SmartRadialMicroChart.prototype.getAccessibilityInfo = function() {
