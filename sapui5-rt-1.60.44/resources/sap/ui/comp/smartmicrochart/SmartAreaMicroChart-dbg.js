...
sap.ui.define([
	...
	SmartAreaMicroChart.prototype.addAriaLabelledBy = function (vAriaLabelledBy) {
		this.addAssociation("ariaLabelledBy", vAriaLabelledBy, true);
		this.getAggregation("_chart").addAriaLabelledBy(vAriaLabelledBy);
		return this;
	};

	SmartAreaMicroChart.prototype.removeAriaLabelledBy = function (vAriaLabelledBy) {
	...
	SmartAreaMicroChart.prototype.removeAllAriaLabelledBy = function () {
	...
	SmartAreaMicroChart.prototype._createChartItem = function(aggregationName, path, color) {
		...
		oPointTemplate = new MicroChartLibrary.AreaMicroChartPoint({
			x: {
				...
				formatter: SmartMicroChartCommons._formatDimension.bind(this)
			},
			y: {
				path: path,
