...
sap.ui.define([
...
], function(library, Control, MicroChartLibrary, MLibrary, SmartMicroChartCommons) {
	"use strict";
	...
	var SmartBulletMicroChart = Control.extend("sap.ui.comp.smartmicrochart.SmartBulletMicroChart", /** @lends sap.ui.comp.smartmicrochart.SmartBulletMicroChart.prototype */ {
		metadata: {
			...
			properties: {
				...
				/**
				 * If this property is set to true, the width and height of the control are determined by the width and height of the container in which the control is placed.
	...
	SmartBulletMicroChart.prototype.addAriaLabelledBy = function (vAriaLabelledBy) {
		this.addAssociation("ariaLabelledBy", vAriaLabelledBy, true);
		this.getAggregation("_chart").addAriaLabelledBy(vAriaLabelledBy);
		return this;
	};

	SmartBulletMicroChart.prototype.removeAriaLabelledBy = function (vAriaLabelledBy) {
	...
	SmartBulletMicroChart.prototype.removeAllAriaLabelledBy = function () {
	...
	SmartBulletMicroChart.prototype.onBeforeRendering = function() {
		...
		oChart.setIsResponsive(this.getIsResponsive());
	...
	SmartBulletMicroChart.prototype._setMode = function () {
		if (SmartMicroChartCommons._hasMember(this, "_oDataPointAnnotations.Visualization.EnumMember")) {
			if (this._oDataPointAnnotations.Visualization.EnumMember === SmartMicroChartCommons._DELTABULLET) {
	...
	SmartBulletMicroChart.prototype.getAccessibilityInfo = function() {
