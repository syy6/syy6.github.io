...
sap.ui.define([
	...
	"sap/suite/ui/microchart/ColumnMicroChartLabel"
			...
			Log, ColumnMicroChart, ColumnMicroChartData, ColumnMicroChartLabel) {
	"use strict";
	 ...
	 */
	var SmartColumnMicroChart = Control.extend("sap.ui.comp.smartmicrochart.SmartColumnMicroChart", /** @lends sap.ui.comp.smartmicrochart.SmartColumnMicroChart.prototype */ {
		metadata: {
			...
			properties: {
				...
				/**
				 * The OData entity set bound to the smart column micro chart.<br>
				...
				/**
				 * If this property is set to <code>true</code>, the width and height of the control are determined by the width and height of the container where the smart column micro chart is included.
			...
			aggregations: {
				/**
				 * This private aggregation is used for the internal binding of the {@link sap.suite.ui.microchart.ColumnMicroChart}
				 */
				_chart: {
					type: "sap.suite.ui.microchart.ColumnMicroChart",
					multiple: false,
					visibility: "hidden"
				} // TODO can i remove _chartTexts from all smart micro charts?
			},
			associations: {
				/**
	...
	SmartColumnMicroChart._CHART_TYPE = ["Column"];
	...
	SmartColumnMicroChart.prototype.onBeforeRendering = function() {
		...
		MicroChartLibrary._passParentContextToChild(this, oChart); // TODO remove after all micro charts are refactored
	};

	SmartColumnMicroChart.prototype.exit = function() {
		SmartMicroChartCommons._cleanup.call(this); // Clean up the instances which were created in SmartMicroChartCommons
	};

	SmartColumnMicroChart.prototype.setEntitySet = function(sEntitySetName) {
	...
	SmartColumnMicroChart.prototype.addAriaLabelledBy = function (vAriaLabelledBy) {
		this.addAssociation("ariaLabelledBy", vAriaLabelledBy, true);
		this.getAggregation("_chart").addAriaLabelledBy(vAriaLabelledBy);
		return this;
	};

	SmartColumnMicroChart.prototype.removeAriaLabelledBy = function (vAriaLabelledBy) {
	...
	SmartColumnMicroChart.prototype.removeAllAriaLabelledBy = function () {
	...
	/**
	 * @returns {sap.ui.comp.smartmicrochart.SmartColumnMicroChart} Reference to 'this' in order to allow method chaining.
	 * @private
	 */
	SmartColumnMicroChart.prototype.setChartType = function() {
		return this;
	};
	 ...
	 * @private
	 */
	SmartColumnMicroChart.prototype.propagateProperties = function() {
	 ...
	 * @private
	 */
	SmartColumnMicroChart.prototype._getBindingPath = function() {
	...
	SmartColumnMicroChart.prototype._createAndBindInnerChart = function() {
		...
		if (this._aDataPointAnnotations[0].Criticality && this._aDataPointAnnotations[0].Criticality.Path) {
			oColumnTemplate.bindProperty("color", this._aDataPointAnnotations[0].Criticality.Path);
		}

		if (this._aDataPointAnnotations[0].Title && this._aDataPointAnnotations[0].Title.Path) { // TODO add to example and ?design time?
			oColumnTemplate.bindProperty("label", this._aDataPointAnnotations[0].Title.Path);
		}

		var oAnnotation = SmartMicroChartCommons._getPropertyAnnotation.call(this, this._aDataPointAnnotations[0].Value.Path);
	...
	SmartColumnMicroChart.prototype._onBindingDataChange = function() {
		...
		SmartMicroChartCommons.updateChartLabels.call(this, oPointsBinding); // TODO add show/hide top/bottom labels for column micro chart, example with/without bottom labels
	};
	 ...
	 * @private
	 */
	SmartColumnMicroChart.prototype._updateAssociations = function(oPointsBinding) {
	 ...
	 * @private
	 */
	SmartColumnMicroChart.prototype._getSupportedChartTypes = function() {
		return SmartColumnMicroChart._CHART_TYPE;
	};
	...
	SmartColumnMicroChart.prototype.getAccessibilityInfo = function() {
