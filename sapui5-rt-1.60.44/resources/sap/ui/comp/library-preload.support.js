...
sap.ui.predefine('sap/ui/comp/rules/SmartForm.support',["sap/ui/support/library"],
	...
	var oSmartFormUseHorizontalLayoutRule = {
			...
			description: "The UseHorizontalLayout property must be set in the SmartForm control and will then be passed on to the Group and GroupElement elements." +
			             "\n It makes no sense to set UseHorizontalLayout for Group or GroupElement elements in a different way than in the SmartForm control." +
			             "\n If UseHorizontalLayout is set for Group or GroupElement elements to another value than on the SmartForm control" +
			             " it will have performance impacts as the logic for the horizontal layout will be performed and internal controls are" +
			             " created and just destroyed.",
