...
// -------------------------------------------------------------------------------
sap.ui.define([
	'sap/ui/model/odata/type/Boolean', 'sap/ui/model/odata/type/Byte', 'sap/ui/model/odata/type/DateTime', 'sap/ui/model/odata/type/DateTimeOffset', 'sap/ui/model/odata/type/Decimal', 'sap/ui/model/odata/type/Double', 'sap/ui/model/odata/type/Single', 'sap/ui/model/odata/type/Guid', 'sap/ui/model/odata/type/Int16', 'sap/ui/model/odata/type/Int32', 'sap/ui/model/odata/type/Int64', 'sap/ui/model/odata/type/SByte', 'sap/ui/model/odata/type/String', 'sap/ui/model/odata/type/Time', 'sap/ui/comp/odata/type/StringDate'
], function(Boolean, Byte, DateTime, DateTimeOffset, Decimal, Double, Single, Guid, Int16, Int32, Int64, SByte, String, Time, StringDate) {
	"use strict";
	...
	var ODataType = {
		 ...
		 * @param {boolean} bIsStringDate if <code>true</code> it is the StringDate {@link sap.ui.comp.odata.type.StringDate} if <code>false</code>
		 *        the type is defined by the Edm.type
		 * @returns {sap.ui.model.SimpleType} the OData type
		 */
		getType: function(sType, oFormatOptions, oConstraints, bIsStringDate) {
