...
sap.ui.define([
	'jquery.sap.global', 'sap/ui/comp/library', 'sap/m/SegmentedButton', 'sap/m/Button', 'sap/m/Text', 'sap/m/FlexItemData', 'sap/ui/core/Item', 'sap/m/OverflowToolbar', 'sap/m/OverflowToolbarButton', 'sap/m/ToolbarSeparator', 'sap/m/ToolbarSpacer', 'sap/m/VBox', 'sap/m/VBoxRenderer', 'sap/ui/comp/providers/ChartProvider', 'sap/ui/comp/smartfilterbar/FilterProvider', 'sap/ui/comp/smartvariants/SmartVariantManagement', 'sap/ui/comp/smartvariants/PersonalizableInfo', 'sap/ui/model/json/JSONModel', 'sap/ui/model/Sorter', 'sap/ui/model/Filter', 'sap/ui/model/FilterOperator', 'sap/ui/comp/personalization/Util', 'sap/ui/Device', 'sap/ui/comp/odata/ODataModelUtil', 'sap/ui/comp/odata/MetadataAnalyser', "sap/m/P13nFilterItem", "sap/ui/comp/state/UIState", "sap/m/SelectionDetails", "sap/m/SelectionDetailsItem", "sap/m/SelectionDetailsItemLine", "sap/m/Title", "sap/ui/comp/util/FormatUtil", "sap/ui/comp/navpopover/NavigationPopoverHandler", "sap/ui/core/InvisibleText", "sap/m/OverflowToolbarLayoutData", 'sap/m/library', 'sap/ui/comp/personalization/Controller', 'sap/ui/comp/personalization/ChartWrapper', 'sap/ui/comp/navpopover/SemanticObjectController', "sap/ui/performance/Measurement", "sap/base/util/UriParameters", "sap/base/Log"
], function(jQuery, library, SegmentedButton, Button, Text, FlexItemData, Item, OverflowToolbar, OverflowToolbarButton, ToolbarSeparator, ToolbarSpacer, VBox, VBoxRenderer, ChartProvider, FilterProvider, SmartVariantManagement, PersonalizableInfo, JSONModel, Sorter, Filter, FilterOperator, PersoUtil, Device, ODataModelUtil, MetadataAnalyser, P13nFilterItem, UIState, SelectionDetails, SelectionDetailsItem, SelectionDetailsItemLine, Title, FormatUtil, NavigationPopoverHandler, InvisibleText, OverflowToolbarLayoutData, MLibrary, PersoController, ChartWrapper, SemanticObjectController, Measurement, UriParameters, Log) {
	"use strict";
	 ...
	 * @class The SmartChart control creates a chart based on OData metadata and the provided configuration. To use the control the <code>entitySet</code>
	 *        property must be specified and the given entity set must belong to an entity type annotated with <code>sap:semantics="aggregate"</code>.
	 *        The entity set is used to fetch properties from OData metadata, from which the chart UI will be generated.<br>
	...
	SmartChart.prototype.init = function() {
		...
		// check if SmartChart shall be created in async mode
		this._sLoadAsync = new UriParameters(window.location.href).get("sap-ui-comp-smartChart-loadAsync");

		if (!this._sLoadAsync || this._sLoadAsync !== "true") {
			// load all dependencies right now synchroniously...
			sap.ui.getCore().loadLibrary('sap.chart');

			//TODO: global jquery call found
			jQuery.sap.require('sap.chart.Chart');
			//TODO: global jquery call found
			jQuery.sap.require('sap.chart.data.Dimension');
			//TODO: global jquery call found
			jQuery.sap.require('sap.chart.data.HierarchyDimension');
			//TODO: global jquery call found
			jQuery.sap.require('sap.chart.data.TimeDimension');
			//TODO: global jquery call found
			jQuery.sap.require('sap.chart.data.Measure');
			//TODO: global jquery call found
			jQuery.sap.require('sap.viz.ui5.controls.VizTooltip');
	...
	SmartChart.prototype._rerenderControlInFullscreen = function() {
		if (this.bFullScreen && this._oFullScreenUtil) {
			this.getChart().setLayoutData(new FlexItemData({
				baseSize: "100%"
			}));
	...
	SmartChart.prototype._onMetadataInitialised = function() {
		...
		if (!this._bMetadataIsInitialised) {
			...
			if (Measurement.getActive()) {
				...
				//console.table(jQuery.sap.measure.getMeasurement("SmartChartInit"));
			}
	...
	SmartChart.prototype._createChart = function() {
		...
		if (oChart) {
			...
			//Resolve promise in case we run async and getChart was called beforehand
			if (this._sLoadAsync === "true" && this._resolveInnerChartCreated) {
				this._resolveInnerChartCreated(this._oChart);
			}
		}
	...
	SmartChart.prototype.getChart = function() {
		// if in async mode return promise and wait resolve after inner chart was created
		if (this._sLoadAsync === "true" && !this._oChart) {
			// for outer scope of resolve object
			this._resolveInnerChartCreated;
			return new Promise(function(resolve/*, reject*/) {
				this._resolveInnerChartCreated = resolve;
			}.bind(this));
		} else {
			return this._oChart;
		}
	...
	SmartChart.prototype._toggleFullScreen = function(bValue, bForced) {
		...
		this._oFullScreenUtil.toggleFullScreen(this, this.bFullScreen, this.oFullScreenButton, this._toggleFullScreen);
