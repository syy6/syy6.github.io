...
sap.ui.define([], function() {
	...
	return {
		annotations: {
			 ...
			 *
			 * <i>XML Example of OData V4 with SelectionFields annotation.</i>
			 *
			 * <pre>
			...
			/**
			 * Defines whether a filter is visible. The <code>SmartFilterBar</code> control interprets the <code>EnumMembers</code> <code>FieldControlType/Inapplicable</code> and <code>FieldControlType/Hidden</code> (deprecated)
			 * of the <code>FieldControl</code> annotation to set the visibility.
			 ...
			 * <b>Note:</b>While properties annotated with <code>HiddenFilter</code> are considered during filtering, properties annotated with <code>Hidden</code> are ignored completely.
			 * If both annotations exist, <code>Hidden</code> is taken into consideration.
			 *
			 * <i>XML Example for OData V4 with Invisible, Filterable LocationName</i>
			 * <pre>
			 ...
			 *
			 * <i>XML Example for OData V4 with Hidden ProductPictureURL</i>
			 *
			 * <pre>
