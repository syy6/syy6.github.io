...
sap.ui.define([
	...
	NavigationPopoverHandler.prototype._createPopover = function() {
		...
		this._oPopover = new NavigationPopover({
			...
			// BCP 1780245154: in touchable devices like e.g. lenovo the afterClose event is triggered
			// after the click event is triggered when another link is pressed on UI
	...
	NavigationPopoverHandler.prototype._createNavigationContainer = function() {
		...
		return new NavigationContainer(sStableId, {
			...
			beforePopoverOpen: function() {
				// Note: in Runtime Adaptation mode we do not open the navigation popover, the selection dialog is opened directly.
				if (this._oPopover) {
