...
sap.ui.define([
	"sap/ui/thirdparty/jquery", 'sap/m/MessageBox', 'sap/ui/comp/filterbar/FilterBar', 'sap/ui/comp/filterbar/FilterGroupItem', 'sap/ui/comp/filterbar/FilterItem', 'sap/ui/comp/library', './AdditionalConfigurationHelper', './ControlConfiguration', './FilterProvider', './GroupConfiguration', 'sap/ui/comp/util/FormatUtil', 'sap/ui/comp/smartvariants/PersonalizableInfo', 'sap/ui/comp/smartvariants/SmartVariantManagement', 'sap/ui/comp/odata/ODataModelUtil', 'sap/ui/core/library', 'sap/ui/comp/variants/VariantItem', 'sap/ui/model/odata/AnnotationHelper', 'sap/ui/model/Context', 'sap/ui/comp/filterbar/VariantConverterFrom', "sap/base/Log"
], function(jQuery, MessageBox, FilterBar, FilterGroupItem, FilterItem, library, AdditionalConfigurationHelper, ControlConfiguration, FilterProvider, GroupConfiguration, FormatUtil, PersonalizableInfo, SmartVariantManagement, ODataModelUtil, coreLibrary, VariantItem, AnnotationHelper, Context, VariantConverterFrom, Log) {
	"use strict";
	...
	SmartFilterBar.prototype.getFilterDataAsStringForVariant = function(bAllFilterData, sVersion) {
		...
		var fDateConvert = function(oValue) {
			...
			if (that.isInUTCMode()) {
				...
				oValue = that.getDateInUTCOffset(oValue).toJSON();
			}
		...
		if (aDateTimeOffsetFilterNames.length > 0) {
			...
			oJson = jQuery.extend(true, oJson, this.getFilterData(bAllFilterData));
	...
	/**
	 * Returns a UTC offset date
	 * @protected
	 * @param {Date} oDate - The input date object
	 * @returns {Date} The UTC offset date object
	 */
	SmartFilterBar.prototype.getDateInUTCOffset = function(oDate) {
		return FilterProvider.getDateInUTCOffset(oDate);
	};
	/**
