...
// ----------------------------------------------------------------
sap.ui.define([
	"sap/ui/thirdparty/jquery", "sap/m/List", "sap/m/ResponsivePopover", "sap/m/CustomListItem", "sap/ui/model/Filter", "sap/ui/model/FilterOperator", "sap/ui/core/syncStyleClass"
], function(jQuery, List, ResponsivePopover, CustomListItem, Filter, FilterOperator, syncStyleClass) {
	"use strict";
	...
	var MultiCurrencyUtil = {
		...
		openMultiCurrencyPopover: function(oEvent, mAdditionalParams) {
			...
			var mCustomParameters = (mBindingInfo && mBindingInfo.parameters && mBindingInfo.parameters.custom) ? jQuery.extend(true, {}, mBindingInfo.parameters.custom) : undefined;
