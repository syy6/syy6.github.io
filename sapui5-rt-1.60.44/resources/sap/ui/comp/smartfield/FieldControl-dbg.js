 ...
 */
sap.ui.define(["sap/ui/comp/smartfield/BindingUtil", "sap/ui/model/ParseException"], function(BindingUtil, ParseException) {
	"use strict";
				...
				case "Edm.SByte":
					fnReturn = function(sValue) {
						...
						if (bEmptyValue) {
							...
							if (that._oAnnotation && !that._oAnnotation.isNullable(oProperty.property)) {
							...
							// the back-end side.
							if (that._oParent.getClientSideMandatoryCheck() && that._oParent.getMandatory()) {
								throw new ParseException(sMessage);
							}
						}
					};
