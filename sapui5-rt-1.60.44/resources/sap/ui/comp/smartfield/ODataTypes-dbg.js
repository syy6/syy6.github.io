...
sap.ui.define([
...
], function(SimpleType, NumberFormat, BooleanType, DoubleType, DateTimeType, StringDateType, DateTimeOffsetType, DecimalType, Int16Type, Int32Type, Int64Type, SByteType, StringType, TextArrangementStringType, TextArrangementGuidType, AbapBoolean, CurrencyType, TimeType, GuidType, MetadataAnalyser) {
	"use strict";
			...
			switch (oProperty.property.type) {
				...
				case "Edm.String":
					...
					if (mSettings.composite) {
						...
						return new TextArrangementStringType(mFormatOptions, mConstraints, this._getTextArrangementOptions(oProperty.valueListAnnotation));
					}
				...
				case "Edm.Guid":
					...
					if (mSettings.composite) {
						mFormatOptions = Object.assign({}, mFormatOptions, this._getTextArrangementFormatOptions());
						return new TextArrangementGuidType(mFormatOptions, mConstraints, this._getTextArrangementOptions(oProperty.valueListAnnotation));
					}
	...
	ODataTypes.prototype._getTextArrangementOptions = function(oValueListAnnotation) {
		return {
	...
	ODataTypes.prototype.getCurrencyType = function(oProperty) {
		...
		if (oProperty) {
			...
			var oFormatOptions = {
				...
				parseAsString: true,
				emptyString: 0,
				precision: oDecimalConstraints.precision,
				maxFractionDigits: oDecimalConstraints.scale
			};
			var oCurrencyConstraints = {
				precision: oDecimalConstraints.precision,
				scale: oDecimalConstraints.scale
			};
