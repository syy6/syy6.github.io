...
sap.ui.define([
	...
	'sap/base/Log'
], function(jQuery, library, EventProvider, ODataType, MetadataAnalyser, FormatUtil, Log) {
	"use strict";
	 ...
	 * @param {string} mParams.fieldName
	 * @param {object} mParams.control
	 * @param {object} mParams.model
	 * @param {object} mParams.filterModel
	 * @param {object} mParams.filterProvider
	 * @param {string} mParams.displayFormat
	 * @param {object} [mParams.dateFormatSettings]
	 * @param {object} mParams.fieldViewMetadata
	 * @protected
	 * @author SAP SE
	 */
	...
	BaseValueListProvider.prototype._getFilterData = function() {
		...
		if (this.oFilterProvider && this.oFilterProvider._oSmartFilter) {
			...
			if (this._fieldViewMetadata && this._fieldViewMetadata.fieldName && (this._fieldViewMetadata.fieldName.indexOf(ANALYTICAL_PARAMETER_PREFIX) === 0)) {
