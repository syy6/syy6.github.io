...
sap.ui.define([
	'sap/ui/thirdparty/jquery', 'sap/ui/core/library', 'sap/m/Bar', 'sap/m/Button', 'sap/m/CheckBox', 'sap/m/Label', 'sap/m/Link', 'sap/m/List', 'sap/m/Panel', 'sap/m/SearchField', 'sap/m/Text', 'sap/m/Toolbar', 'sap/m/ToolbarSpacer', 'sap/ui/Device', 'sap/ui/comp/state/UIState', './VariantConverterFrom', './VariantConverterTo', 'sap/ui/comp/library', 'sap/ui/comp/smartvariants/PersonalizableInfo', 'sap/ui/comp/smartvariants/SmartVariantManagementUi2', 'sap/ui/comp/variants/VariantManagement', 'sap/ui/core/InvisibleText', 'sap/ui/core/Icon', 'sap/ui/core/Title', 'sap/ui/layout/Grid', 'sap/ui/layout/GridRenderer', 'sap/ui/layout/GridData', 'sap/ui/layout/HorizontalLayout', 'sap/ui/layout/VerticalLayout', 'sap/ui/layout/AlignedFlowLayout', 'sap/ui/comp/util/IdentifierUtil', 'sap/m/library', 'sap/ui/core/ResizeHandler', 'sap/ui/model/json/JSONModel', 'sap/ui/comp/filterbar/FilterGroupItem', 'sap/base/Log'
], function(jQuery, coreLib, Bar, Button, CheckBox, Label, Link, List, Panel, SearchField, Text, Toolbar, ToolbarSpacer, Device, UIState, VariantConverterFrom, VariantConverterTo, library, PersonalizableInfo, SmartVariantManagementUi2, VariantManagement, InvisibleText, Icon, Title, Grid, GridRenderer, GridData, HorizontalLayout, VerticalLayout, AlignedFlowLayout, IdentifierUtil, mLibrary, ResizeHandler, JSONModel, FilterGroupItem, Log) {
	"use strict";
	...
	FilterBar.prototype.applySettings = function(mSettings) {
		...
		if (!this._oVariantManagement || (this._oVariantManagement && (!this._oVariantManagement.getVisible() || !this._oVariantManagement.isA("sap.ui.comp.smartvariants.SmartVariantManagement")))) {
