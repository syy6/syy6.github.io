...
sap.ui.define([
	...
	ValueHelpDialog.prototype._createRanges = function() {
		...
		if (!this._aIncludeRangeOperations["string"]) {
			// add the empty operator
			this._oFilterPanel.getIncludeOperations("string").push(sap.m.P13nConditionOperation.Empty);
		}
		...
		if (!this._aExcludeRangeOperations["string"]) {
			// add the empty operator
			if (this._oFilterPanel.getExcludeOperations("string")) {
				this._oFilterPanel.getExcludeOperations("string").push(sap.m.P13nConditionOperation.Empty);
			} else {
				this._oFilterPanel.setExcludeOperations([sap.m.P13nConditionOperation.EQ, sap.m.P13nConditionOperation.Empty], "string");
			}
		}
