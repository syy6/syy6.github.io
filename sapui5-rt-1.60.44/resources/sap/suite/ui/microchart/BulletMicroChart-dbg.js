...
sap.ui.define([
	...
	BulletMicroChart.prototype._onResize = function() {
		var $this = this.$(),
			iCurrentControlHeight = parseInt($this.css("height"), 10),
			iCurrentControlWidth = parseInt($this.css("width"), 10);
	...
	BulletMicroChart.prototype.getAltText = function(bIsActive) {
