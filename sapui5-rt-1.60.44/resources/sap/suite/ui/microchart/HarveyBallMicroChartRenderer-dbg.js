...
sap.ui.define([
	...
	"sap/m/ValueColor",
	"sap/m/ValueCSSColor"
], function(jQuery, MobileLibrary, Device, library, HarveyBallMicroChart, encodeXML, MicroChartRenderUtils, Parameters, ValueColor, ValueCSSColor) {
	"use strict";
	...
	HarveyBallMicroChartRenderer.render = function(oRm, oControl) {
		if (oControl._hasData()) {
			...
			oRm.addClass(oControl.getIsResponsive() ? "sapSuiteHBMCResponsive" : encodeXML(sSizeClass));
			oRm.writeClasses();
			...
			if (!oControl.getIsResponsive()) {
				oRm.write("<div");
				oRm.addClass("sapSuiteHBMCValueContainer");
				oRm.addClass(encodeXML(sSizeClass));
				oRm.writeClasses();
	...
	HarveyBallMicroChartRenderer._writeMainProperties = function(oRm, oControl) {
		...
		oRm.addClass(oControl.getIsResponsive() ? "sapSuiteHBMCResponsive" : "sapSuiteHBMCSize" + oControl.getSize());
