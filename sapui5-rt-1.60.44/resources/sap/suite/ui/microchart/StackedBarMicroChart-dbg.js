...
sap.ui.define([
...
], function(jQuery, library, Control, Size, ValueColor, Device, FlexBox, MicroChartUtils, ResizeHandler) {
	"use strict";
	 ...
	 * @private
	 */
	StackedBarMicroChart.prototype._createTooltipText = function(aChartData, bIsActive) {
		var sTooltipText = this._oRb.getText("STACKEDBARMICROCHART");
