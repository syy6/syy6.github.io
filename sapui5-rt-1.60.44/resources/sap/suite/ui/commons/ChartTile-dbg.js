...
sap.ui.define([ 'jquery.sap.global', './InfoTile' ], function(jQuery, InfoTile) {
	"use strict";
	...
	ChartTile.prototype._addDescriptionMargin = function() {
		if (this.getDescription() && this.getUnit()) {
			var $Description = jQuery(document.getElementById(this.getId() + "-description")).hide();
			var iWidth = jQuery(document.getElementById(this.getId() + "-unit")).outerWidth() + 1; // add 1 to eliminate rounding issue in IE
