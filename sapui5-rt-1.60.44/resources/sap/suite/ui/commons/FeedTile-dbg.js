...
sap.ui.define([ 'jquery.sap.global', './library', 'sap/ui/core/Control', 'sap/suite/ui/commons/util/FeedItemUtils', 'sap/base/Log' ],
	function(jQuery, library, Control, FeedItemUtils, Log) {
	"use strict";
	...
	FeedTile.prototype.setNextItemValues = function() {
		...
		jQuery("#" + id + "-next-feedTileAge").html(jQuery.sap.encodeHTML(FeedItemUtils.calculateFeedItemAge(oNextItem.getPublicationDate())));
	};
