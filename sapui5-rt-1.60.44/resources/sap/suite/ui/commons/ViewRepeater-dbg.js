...
sap.ui.define([ 'jquery.sap.global', './library', 'sap/ui/commons/library', 'sap/ui/commons/RowRepeater', 'sap/ui/commons/SegmentedButton', 'sap/ui/commons/SearchField', 'sap/ui/commons/Button',
				'sap/ui/base/ManagedObject', 'sap/ui/core/ResizeHandler' ],
	function(jQuery, library, CommonsLibrary, RowRepeater, SegmentedButton, SearchField, Button, ManagedObject, ResizeHandler) {
	"use strict";
	...
	ViewRepeater.prototype.onAfterRendering = function() {
		...
		if (this.getResponsive()) {
			...
			setTimeout(function () {
				this._sResizeListenerId = ResizeHandler.register(jQuery.sap.domById(this.getId() + "-body"), jQuery.proxy(this._handleResize, this));
				if (this.getShowMoreSteps() === 0) {
