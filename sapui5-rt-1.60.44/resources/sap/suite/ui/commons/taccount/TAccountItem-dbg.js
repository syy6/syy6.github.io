sap.ui.define([
	...
	var TAccountItem = Control.extend("sap.suite.ui.commons.taccount.TAccountItem", {
		...
		renderer: function (oRm, oItem) {
			...
			var sAriaLabel = oItem.getAriaLabel();
			if (sAriaLabel) {
	...
	TAccountItem.prototype._highlightItems = function () {
		...
		jQuery(".sapSuiteUiCommonsAccountItemSelected").removeClass("sapSuiteUiCommonsAccountItemSelected");
		...
		if (oPanel) {
			jQuery(".sapSuiteUiCommonsAccountItemSelectedByGroup").removeClass("sapSuiteUiCommonsAccountItemSelectedByGroup");
			if (sGroup && bSelect) {
