sap.ui.define([
		...
		"./TAccountUtils"
				 ...
				 ToolbarSpacer, Text, SegmentedButton, SegmentedButtonItem, FilterOperator, encodeXML, NumberFormat, Core, Configuration, ButtonType, TAccountUtils) {
		"use strict";
		...
		TAccountPanel.prototype._valueChanged = function (iDiff) {
			var oSum = this.getSum();
			if (oSum.correct) {
