...
sap.ui.define([ 'jquery.sap.global', './library', 'sap/m/library', 'sap/ui/base/ManagedObject', 'sap/ui/core/Control', 'sap/ui/core/delegate/ItemNavigation', 'sap/m/ScrollContainer', 'sap/m/Button', 'sap/ui/core/delegate/ScrollEnablement', 'sap/ui/Device', 'sap/ui/core/ResizeHandler' ],
	function(jQuery, library, MobileLibrary, ManagedObject, Control, ItemNavigation, ScrollContainer, Button, ScrollEnablement, Device, ResizeHandler) {
	"use strict";
		...
		if (jQuery.device.is.desktop) {
			...
			this._oScrollCntr.addDelegate({
				onAfterRendering: function() {
					if (jQuery.device.is.desktop) {
						var oFocusRef = jQuery.sap.domById(this.getId() + "-scrl-cntnr-scroll");
	...
	HeaderContainer.prototype.setView = function(view) {
		...
		if (view === library.HeaderContainerView.Horizontal && !jQuery.device.is.desktop) {
