sap.ui.define([
	...
	CalculationBuilderItem.prototype._innerRender = function () {
		...
		if (this._isEmpty()) {
			...
			sHtml += jQuery.sap.encodeHTML(sLabel);
			sHtml += "</span>";
			sHtml += "</div>";
		}
	...
	CalculationBuilderItem.prototype._render = function () {
		...
		sHtml += "<div " + " class=\"" + this._getClass(!!oError) + "\" id=\"" + this.getId() + "\" tabindex=\"" + (bIsItemInBuilder ? "-1" : "0") + "\">";
	...
	/* =========================================================== */
	CalculationBuilderItem.prototype._setupMobileDraggable = function () {
