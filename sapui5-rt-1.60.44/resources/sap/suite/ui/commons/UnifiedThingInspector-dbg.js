...
sap.ui.define([ 'jquery.sap.global', './library', 'sap/m/library', 'sap/ui/core/Control', 'sap/m/NavContainer', 'sap/ui/core/IconPool', 'sap/ui/layout/Grid', 'sap/ui/layout/GridData', 'sap/m/ActionSheet',
				'sap/suite/ui/commons/LinkActionSheet', 'sap/m/ScrollContainer', 'sap/m/Page', 'sap/m/Bar', 'sap/m/Button', 'sap/ui/Device', 'sap/ui/core/ResizeHandler',
				'sap/ui/base/ManagedObject', 'sap/m/ObjectHeader', 'sap/m/ObjectAttribute', 'sap/m/Image', 'sap/ui/core/Icon', 'sap/ui/events/KeyCodes', 'sap/base/Log' ],
	function(jQuery, library, Mobilelibrary, Control, NavContainer, IconPool, Grid, GridData, ActionSheet, LinkActionSheet, ScrollContainer, Page, Bar, Button, Device, ResizeHandler, ManagedObject,
	         ObjectHeader, ObjectAttribute, Image, Icon, KeyCodes, Log) {
	"use strict";
