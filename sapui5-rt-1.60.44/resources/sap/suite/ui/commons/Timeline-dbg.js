...
sap.ui.define([
		...
		"sap/base/Log"
				 ...
				 ManagedObject, TimelineItem, TimelineRenderManager, ScrollEnablement, ODataListBindingV4, assert, Log) {
		"use strict";
		...
		function findIndex(aArray, fnCallback) {
			...
			assert(jQuery.isArray(aArray), "aArray must be an array.");
		...
		Timeline.prototype._getTimeFilterData = function () {
			var that = this, //eslint-disable-line
				...
				fnGetLimitValue = function (asc) {
					...
					} else if (oListBinding instanceof ODataListBindingV4) {
						that._setBusy(true);
		...
		Timeline.prototype._openFilterDialog = function () {
			...
			if (this._customFilter) {
				oCustomFilter = this.getCustomFilter();
				...
				this.oItemNavigation.attachEvent("AfterFocus", function (oEvent) {
					...
					if (aFocusedItems[0]) {
						this.fireSelect({
							...
							userAction: oEvent.mParameters.event.type === "mousedown"
						});
					}
				}, this);
