...
sap.ui.define([
	...
	function(jQuery, library, MobileLibrary, Control, ProcessFlowConnection, ProcessFlowLaneHeader, Device, ResizeHandler, KeyCodes, Log) {
		"use strict";
	...
	ProcessFlow.prototype._setFocusOnHeader = function(navigationFocusFlag) {
		var thead = jQuery(document.getElementById(this.getId() + "-thead"));
