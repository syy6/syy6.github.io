...
sap.ui.define([ 'jquery.sap.global', './library', 'sap/ui/commons/library', './util/DateUtils', 'sap/ui/commons/Label', 'sap/ui/core/Control', 'sap/ui/core/format/DateFormat', 'sap/base/Log' ],
	function(jQuery, library, CommonsLibrary, DateUtils, Label, Control, DateFormat, Log) {
	"use strict";
	...
	DateRangeScroller.prototype.onclick = function(oEvent) {
		switch (oEvent.target) {
			case jQuery(document.getElementById(this.getId() + '-decrementScrollButton'))[0]:
				this.decrementDateRange();
				break;
			case jQuery(document.getElementById(this.getId() + '-incrementScrollButton'))[0]:
				this.incrementDateRange();
				break;
			default:
				break;
		}
		jQuery(document.getElementById(this.getId() + "-labelarea")).focus();
	};
