...
sap.ui.define([ 'jquery.sap.global', './library', 'sap/ui/core/Control', 'sap/ui/core/Icon', 'sap/ui/events/KeyCodes' ],
	function(jQuery, library, Control, Icon, KeyCodes) {
	"use strict";
	...
	MonitoringContent.prototype.onAfterRendering = function() {
		if (library.LoadState.Loaded === this.getState() || this.getAnimateTextChange()) {
			jQuery(document.getElementById(this.getId())).animate({ opacity: "1" }, 1000);
		}
	};
