...
sap.ui.define([
...
], function (jQuery, Control, Text, Toolbar, ToolbarDesign, Link, TextArea, Popover, PlacementType, ToolbarSpacer, Button, Device, ManagedObjectRegister, DateUtils, Icon,
             MobileLibrary, DateFormat, ODataModelv4) {
	"use strict";
	...
	TimelineItem.prototype.setDateTime = function (oDateTime) {
		if (oDateTime && this.getBinding("dateTime") && (this.getModel() instanceof ODataModelv4)) {
