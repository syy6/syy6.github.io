...
sap.ui.define([ 'jquery.sap.global', './library', 'sap/m/library', 'sap/viz/library', 'sap/ui/base/ManagedObject', 'sap/m/Button', 'sap/m/ButtonType', 'sap/m/OverflowToolbar', 'sap/m/OverflowToolbarButton', 'sap/m/SegmentedButton', 'sap/m/Title', 'sap/m/ToolbarSpacer', 'sap/ui/Device', 'sap/ui/core/Control', 'sap/ui/core/CustomData', 'sap/ui/core/Popup', 'sap/ui/core/ResizeHandler', 'sap/ui/core/delegate/ScrollEnablement', 'sap/m/ToggleButton', 'sap/base/Log' ],
	function(jQuery, library, MobileLibrary, VizLibrary, ManagedObject, Button, ButtonType, OverflowToolbar, OverflowToolbarButton, SegmentedButton, Title, ToolbarSpacer, Device, Control, CustomData, Popup, ResizeHandler, ScrollEnablement, ToggleButton, Log) {
	"use strict";
	...
	/*Toggle of ZoomIn and ZoomOut Button on reaching Threshold value*/
		var iZoomInfo = oChart._getZoomInfo().currentZoomLevel;
