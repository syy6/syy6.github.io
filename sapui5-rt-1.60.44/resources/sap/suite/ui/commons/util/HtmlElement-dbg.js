...
sap.ui.define([ "jquery.sap.global", "sap/ui/base/Object", "sap/ui/core/Control", "./HtmlElementRenderer", "sap/base/assert", "sap/base/Log" ],
	function(jQuery, BaseObject, Control, HtmlElementRenderer, assert, Log) {
	"use strict";
	...
	HtmlElement.prototype.addClass = function(sClass) {
		...
		if (!this._mAttributes.class) {
			...
			assert(jQuery.isArray(this._mAttributes.class), "Cannot add class to customly added classes.");
		}
	...
	HtmlElement.prototype.addStyle = function(sName, oValue) {
		...
		if (!this._mAttributes.style) {
			...
			assert(jQuery.isArray(this._mAttributes.style), "Cannot add style to customly added styles.");
		}
