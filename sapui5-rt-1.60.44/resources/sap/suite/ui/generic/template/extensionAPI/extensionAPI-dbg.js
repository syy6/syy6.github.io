sap.ui.define(["jquery.sap.global", "sap/suite/ui/generic/template/lib/TemplateAssembler"], function(jQuery, TemplateAssembler) {
	"use strict";
		...
		registerControllerExtensions: function(sControllerExtensionName, mEntitySetToImplementation){
			var oControllerDefinition = {
				onInit: function(){
					...
					var fnInit = (oImplementation && oImplementation.onInit) || jQuery.noop;
			...
			var fnCreateControllerMethod = function(sMethod){
				...
				return function(){
					...
					var fnImplementation = mEntitySetToImpl[sEntitySetName] || function(){
						jQuery.sap.log.error("No implementation for function " + sMethod + " for entity set " + sEntitySetName);                                    	
					};
