...
*/
sap.ui.define(["sap/suite/ui/generic/template/extensionAPI/UIMode"], function(UIMode) {
	"use strict";
	
	function fnFormatId(oReuseComponent, sSuffix){
		return (oReuseComponent.componentName || oReuseComponent.componentUsage) + "::" + oReuseComponent.id + "::" + sSuffix;                         
	}
