...
sap.ui
	.define(["jquery.sap.global", "sap/ui/core/mvc/ControllerExtension", "sap/ui/core/mvc/OverrideExecution", "sap/ui/core/mvc/View", 
			...
			"sap/suite/ui/generic/template/lib/testableHelper", "sap/suite/ui/generic/template/support/lib/CommonMethods"
		],
		function(jQuery, ControllerExtension, OverrideExecution, View, JSONModel, ResourceModel, TemplateViewController, TemplateComponent, Application, CRUDManager, CommonUtils,
			ComponentUtils, CommonEventHandlers, ViewDependencyHelper, routingHelper, testableHelper, CommonMethods) {
			"use strict";
			...
			// - reuseComponentProxies: A map, mapping the keys of embedded reuse components onto their 'proxies'. Theeby the proxy has the structure as being defined in method mixInto of class ReuseComponentSupport.
			...
			// - oTemplateContract: The TemplateContract of the app (see class AppComponent for details on the AppComponent)
			...
			// In method getTemplateViewController (more precisely: within the constructor created within this method) the following property is added:
			...
			// - oComponentRegistryEntry is the registry entry of the component (see function getComponentRegistryEntry) the view belongs to
			...
			//   getTemplateViewController will set the metadata accordingly, if oControllerExtensionDefinition does not provide contradicting information.
			...
			function getTemplateViewController(getMethods, oComponentRegistryEntry, oControllerDefinition, oControllerExtensionDefinition, oTemplateUtils, oAppRegistryEntry) {
				var sControllerName = oComponentRegistryEntry.oComponent.getTemplateName();
				oControllerDefinition = jQuery.extend(true, {}, oControllerDefinition);
				oControllerExtensionDefinition = jQuery.extend(true, {}, oControllerExtensionDefinition);
				var fnOnInit, fnOnExit;
				var oExtensionAPI;
				...
				oControllerDefinition.constructor = function() {
					...
					oExtensionAPI = Object.freeze(oMethods.extensionAPI || {});
					...
					fnOnInit = function() {
						...
						oTemplateUtils.oCommonUtils = new CommonUtils(this, oTemplateUtils.oServices, oTemplateUtils.oComponentUtils);
						oTemplateUtils.oServices.oCRUDManager = new CRUDManager(this,
						...
						oTemplateUtils.oCommonEventHandlers = new CommonEventHandlers(this,
			...
			// These three properties will be passed to getTemplateViewController. See documentation of that method for the expected structure of these objects.
			function fnGetViewControllerCreator(oComponentRegistryEntry) {
				...
				return oControllerSpecification && function(){
					...
					return getTemplateViewController(oControllerSpecification.getMethods, oComponentRegistryEntry, oControllerSpecification.oControllerDefinition, oControllerSpecification.oControllerExtensionDefinition, oTemplateUtils, oAppRegistryEntry);
				};
			}
				...
				getTemplateComponent: function(getMethods, sComponentName, oComponentDefinition) {
					...
					oComponentDefinition.onActivate = function(sBindingPath, bIsComponentCurrentlyActive) {
						...
						var fnActivate = function() {
							...
							return (oComponentRegistryEntry.methods.onActivate || jQuery.noop)(sBindingPath, bIsComponentCurrentlyActive);
						};
					...
					oComponentDefinition.setIsRefreshRequired = function(bIsRefreshRequired) {
						if (bIsRefreshRequired){ // check whether refresh must be performed immediately
							var oComponentRegistryEntry = getComponentRegistryEntry(this);
							if (oComponentRegistryEntry.utils.isComponentActive()){
