sap.ui.define(["jquery.sap.global", "sap/ui/base/Object", "sap/suite/ui/generic/template/lib/MessageUtils", "sap/suite/ui/generic/template/lib/testableHelper"],
	function(jQuery, BaseObject, MessageUtils, testableHelper) {
		...
		function getMethods(oTemplateContract) {
			...
			function logSupportInfo(method, busyEndedPromise, reason) {
				...
				if (jQuery.sap.log.getLevel(sType) < jQuery.sap.log.Level.INFO) {
					jQuery.sap.log.setLevel(jQuery.sap.log.Level.INFO, sType);
				}
				jQuery.sap.log.info("busyHandling: " + method, reason + " called", sType, function() {
					var oSupportInfo = {
						method: method,
						reason: reason,
