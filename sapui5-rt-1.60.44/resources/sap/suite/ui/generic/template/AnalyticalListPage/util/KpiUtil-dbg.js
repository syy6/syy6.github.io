sap.ui.define([
	...
	],	function(BaseObject, Context, V4Terms, Locale, NumberFormat, FilterOperator) {
		"use strict";
    ...
    */
	...
	KpiUtil.updateKpiList = function (oKpi, bProcessed) {
		try {
			...
			jQuery.sap.log.error("KPI processing failed: " + oKpi.getId() + " : " + oError);
		}
	};
	...
	KpiUtil.addToKpiList = function (mSettings, oKpi) {
		try {
			...
			jQuery.sap.log.error("KPI processing failed: " + sKpiId + " : " + oError);
		}
	};
