sap.ui.define([
	...
	], function(jQuery, Controller, Filter, JSONModel, Button, StandardListItem, List, ToolbarSpacer, FilterUtil, ResponsivePopover, Label, ToggleButton,
		SearchField, Toolbar, Icon, Sorter, FilterOperator, SapMLibrary) {
	"use strict";
