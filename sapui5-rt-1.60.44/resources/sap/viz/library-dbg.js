...
sap.ui.define([
	...
	function(Core, library1, Log, ObjectPath, jQuery)	{
	"use strict";
	...
	if (sap.viz.__svg_support) {
		...
		sap.ui.requireSync("sap/ui/thirdparty/d3");

		sap.ui.requireSync("sap/ui/thirdparty/require");

		sap.ui.requireSync("sap/ui/thirdparty/jqueryui/jquery-ui-core");

		sap.ui.requireSync("sap/ui/thirdparty/jqueryui/jquery-ui-widget");

		sap.ui.requireSync("sap/ui/thirdparty/jqueryui/jquery-ui-mouse");

		sap.ui.requireSync("sap/ui/thirdparty/jqueryui/jquery-ui-draggable");

		sap.ui.requireSync("sap/ui/thirdparty/jqueryui/jquery-ui-droppable");

		sap.ui.requireSync("sap/viz/libs/canvg");

		sap.ui.requireSync("sap/viz/libs/rgbcolor");

		sap.ui.requireSync("sap/viz/libs/sap-viz-info-framework");

		sap.ui.requireSync("sap/viz/libs/sap-viz-info-charts");

		sap.ui.requireSync("sap/viz/resources/chart/templates/standard_fiori/template");

		sap.ui.requireSync("sap/viz/ui5/controls/libs/sap-viz-vizframe/sap-viz-vizframe");

		sap.ui.requireSync("sap/viz/ui5/controls/libs/sap-viz-vizservices/sap-viz-vizservices");
