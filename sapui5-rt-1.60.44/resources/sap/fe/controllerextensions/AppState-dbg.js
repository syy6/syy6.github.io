...
sap.ui.define([
	...
	function (ControllerExtension, JSONModel, HashChanger) {
		'use strict';
		 ...
		 *
		 * @namespace
		 * @alias sap.fe.controllerextensions.AppState
		 *
		 * @sap-restricted
		 * @experimental This module is only for experimental use! <br/><b>This is only a POC and maybe deleted</b>
		 * @since 1.54.0
		 */
		var Extension = ControllerExtension.extend('sap.fe.controllerextensions.AppState', {
			/**
			 * initialize the app state handling
			 *
			 * @function
			 * @name sap.fe.controllerextensions.AppState#initializeAppState
			 * @memberof sap.fe.controllerextensions.AppState
			 * @static
			...
			initializeAppState: function (oAppComponent) {
				...
				var oAppContainer = sap.fe.controllerextensions.AppState.mAppContainer[oAppComponent.getId()] = {
					appStateModels : {}
				};
				...
				oRouter.attachRouteMatched(function (oEvent) {
					...
					if (sAppStateKey) {
						...
						if (sAppStateKey) {
							...
							sap.ushell.Container.getService("CrossApplicationNavigation").getAppState(oAppComponent, sAppStateKey).done(function (oStartupInnerAppState) {
			 ...
			 *
			 * @function
			 * @name sap.fe.controllerextensions.AppState#cleanupAppState
			 * @memberof sap.fe.controllerextensions.AppState
			 * @static
			 * @param {sap.ui.core.Component} application component owning the routing
			 *
			...
			cleanupAppState: function (oAppComponent) {
				if (sap.fe.controllerextensions.AppState.mAppContainer[oAppComponent.getId()]) {
					delete sap.fe.controllerextensions.AppState.mAppContainer[oAppComponent.getId()];
				}
			},
			 ...
			 *
			 * @function
			 * @name sap.fe.controllerextensions.AppState#requestAppStateModel
			 * @memberof sap.fe.controllerextensions.AppState
			 * @static
			...
			_updateAppState: function (sId) {
				...
				oAppContainer.oAppState = sap.ushell.Container.getService("CrossApplicationNavigation").createEmptyAppState(this._getOwnerComponent());
			...
			_getAppContainer: function () {
				return sap.fe.controllerextensions.AppState.mAppContainer[this._getOwnerComponent().getId()];
			}

		});

		// a Singleton map that contains an app container for each application component
		sap.fe.controllerextensions.AppState.mAppContainer = {};
