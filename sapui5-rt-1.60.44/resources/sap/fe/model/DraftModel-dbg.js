...
sap.ui.define([
...
], function (JSONModel, ODataListBinding, Context, Filter, ManagedObject, ChangeReason, ResourceModel, testableHelper, ODataContextBinding) {
	"use strict";
	...
	function addOperationsToContext(oContext, oEntitySet) {
		var oOperations = oEntitySet["@"]["@com.sap.vocabularies.Common.v1.DraftRoot"] || oEntitySet["@"]["@com.sap.vocabularies.Common.v1.DraftNode"];
