 ...
 */
sap.ui.define([
	"sap/ui/core/Core", "sap/gantt/misc/Utility", "sap/gantt/misc/Format", "sap/base/util/ObjectPath"
], function (Core, Utility, Format, ObjectPath) {
	...
	AxisTime.prototype._getTimeIntervalTicks = function (oTimeInterval, visibleScale) {
		...
		var iFirstDayOfWeek = sap.ui.core.LocaleData.getInstance(oLocale).getFirstDayOfWeek();
		var aWeekFirstDays = [
			"d3.time.sunday",
			"d3.time.monday",
			"d3.time.tuesday",
		...
		return visibleScale.ticks(ObjectPath.get(aWeekFirstDays[iFirstDayOfWeek]).range, oTimeInterval.span);
