 ...
 */
sap.ui.define(["sap/base/assert", "sap/base/util/array/uniqueSort", "sap/base/util/uid", "sap/gantt/misc/Format", "sap/gantt/config/TimeHorizon", "sap/base/Log"], function (assert, uniqueSort, uid, Format, TimeHorizon, Log) {
	"use strict";
