...
function (
	...
	GanttChart.prototype.init = function () {
		...
		Measurement.start("GanttChart init","GanttPerf:GanttChart init function");
		// create tree table
		...
		Measurement.end("GanttChart init");
	};
	...
	GanttChart.prototype.setTableProperties = function (oProperties) {
		if (oProperties.hasOwnProperty("selectionBehavior")) {
			if (oProperties.selectionBehavior !== sap.ui.table.SelectionBehavior.RowOnly) {
				...
				Log.warning("Change GanttChart's TreeTable selectionBehavior is not allowed!");
			}
		}
	...
	GanttChart.prototype.addRelationship = function (oRelationship) {
		Log.error("The control manages the relationships aggregation. The method \"addRelationship\" cannot be used programmatically!");
	};
	/*
	 * @see JSDoc generated by SAPUI5 control API generator
	 */
	GanttChart.prototype.insertRelationship = function (iIndex, oRelationship) {
		Log.error("The control manages the relationships aggregation. The method \"insertRelationship\" cannot be used programmatically!");
	};
	/*
	 * @see JSDoc generated by SAPUI5 control API generator
	 */
	GanttChart.prototype.removeRelationship = function (oRelationship) {
		Log.error("The control manages the relationships aggregation. The method \"removeRelationship\" cannot be used programmatically!");
	};
	/*
	 * @see JSDoc generated by SAPUI5 control API generator
	 */
	GanttChart.prototype.getRelationships = function () {
		Log.error("The control manages the relationships aggregation. The method \"getRelationships\" cannot be used programmatically!");
	};
	/*
	 * @see JSDoc generated by SAPUI5 control API generator
	 */
	GanttChart.prototype.destroyRelationships = function () {
		Log.error("The control manages the relationships aggregation. The method \"destroyRelationships\" cannot be used programmatically!");
	};
	/*
	 * @see JSDoc generated by SAPUI5 control API generator
	 */
	GanttChart.prototype.indexOfRelationship = function (oRelationship) {
		Log.error("The control manages the relationships aggregation. The method \"indexOfRelationship\" cannot be used programmatically!");
	};
	/*
	 * @see JSDoc generated by SAPUI5 control API generator
	 */
	GanttChart.prototype.removeAllRelationships = function () {
		Log.error("The control manages the relationships aggregation. The method \"removeAllRelationships\" cannot be used programmatically!");
	};
	...
	GanttChart.prototype.getSelectedRows = function () {
		...
		var aSelectedRowData = this._getDrawingData(undefined, aSelectedIndexs);
	...
	GanttChart.prototype._syncTTSelection = function(event){
		Measurement.start("GanttChart syncTTSelection","GanttPerf:GanttChart syncTTSelection function");
		...
		Measurement.end("GanttChart syncTTSelection");
	};
	...
	GanttChart.prototype._onKeyDown = function (oEvent) {
		if (oEvent.which === KeyCodes.Z && this._oTimePeriodZoomHandler.isTimePeriodZoomEnabled()) {
	...
	GanttChart.prototype._drawSvg = function () {
		Measurement.start("GanttChart _drawSvg","GanttPerf:GanttChart _drawSvg function");
		...
		Measurement.end("GanttChart _drawSvg");
	};
