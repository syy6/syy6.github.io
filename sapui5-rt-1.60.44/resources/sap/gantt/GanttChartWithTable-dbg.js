...
function (
	...
	GanttChartWithTable.prototype.init = function () {
		...
		// create chart
		Measurement.start("GanttChartWithTable Init","GanttPerf:GanttChartWithTable Init function");
		...
		Measurement.end("GanttChartWithTable Init");
	};
	...
	GanttChartWithTable.prototype._bindAggregation = function (sName, oBindingInfo) {
		...
		if (sName == "rows" && oBindingInfo){
			...
			this._oTT._oSelectionAdapter = this._oTC._oSelectionAdapter;
	...
	GanttChartWithTable.prototype._onRowSelectionChange = function (oEvent){
		...
		this._oTT._updateSelection(); //sync selection of oTC and oTT -- when table impl changes, change accordingly
	};
