 ...
 */
sap.ui.define([
	"sap/ui/core/Control", "sap/ui/core/Core", "sap/ui/base/ManagedObjectMetadata", "sap/m/OverflowToolbar", "sap/m/OverflowToolbarLayoutData", "sap/m/ToolbarSpacer", "sap/m/FlexBox", "sap/m/library",
	"sap/m/Button", "sap/m/SegmentedButton", "sap/m/Select", "sap/m/MenuButton", "sap/m/Menu", "sap/m/MenuItem",
	"sap/ui/core/Item", "sap/m/ViewSettingsDialog", "sap/m/ViewSettingsCustomTab",
	"sap/m/CheckBox", "sap/ui/core/library", "./AssociateContainer", "sap/gantt/legend/LegendContainer", "sap/gantt/misc/Utility", "sap/m/Slider", "sap/m/Popover"
], function (Control, Core, ManagedObjectMetadata, OverflowToolbar, OverflowToolbarLayoutData, ToolbarSpacer, FlexBox, mobileLibrary,
		Button, SegmentedButton, Select, MenuButton, Menu, MenuItem, CoreItem, ViewSettingsDialog, ViewSettingsCustomTab, CheckBox,
		coreLibrary, AssociateContainer, LegendContainer, Utility, Slider, Popover) {
	"use strict";
