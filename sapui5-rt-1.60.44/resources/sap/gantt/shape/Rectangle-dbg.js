 ...
 */
sap.ui.define([
	"sap/base/Log", "sap/gantt/shape/Shape", "sap/gantt/misc/Format", "sap/ui/core/Core"
], function (Log, Shape, Format, Core) {
	"use strict";
	...
	Rectangle.prototype.getX = function (oData, oRowInfo) {
		...
		if (!jQuery.isNumeric(nTimeX)) {
			Log.warning("Cannot get start time or end time from shape data: " + oData + ", please check whether the attribute name");
			return 0;
		}
		return nTimeX;
	};
