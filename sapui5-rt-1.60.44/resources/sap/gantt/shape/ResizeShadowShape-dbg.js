...
sap.ui.define([
	"sap/base/Log", "sap/gantt/shape/Path", "sap/gantt/misc/Format", "sap/ui/core/Core"
], function (Log, Path, Format, Core) {
	"use strict";
	...
	ResizeShadowShape.prototype.getD = function (oData, oRowInfo) {
		...
		if (this.isValid(sPath)) {
			...
			Log.warning("ResizeShadowShape generated invalid d: " + sPath + " from the given data: " + oData);
			return null;
		}
	};
