 ...
 */
sap.ui.define([
	"sap/base/Log", "sap/gantt/misc/Format", "sap/gantt/shape/Path"
], function(Log, Format, Path) {
	"use strict";
	...
	UbcBorderPath.prototype.getD = function(oData, oRowInfo) {
		...
		if (this.isValid(path)) {
			...
			Log.warning("UbcBorderPath shape generated invalid d: " + path + " from the given data: " + oData);
			return null;
		}
	};
