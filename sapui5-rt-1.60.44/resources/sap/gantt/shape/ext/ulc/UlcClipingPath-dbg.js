 ...
 */
sap.ui.define([
	"sap/base/Log", "sap/gantt/shape/Path", "sap/gantt/misc/Format"
], function(Log, Path, Format){
	"use strict";
	...
	UlcClipingPath.prototype.getD = function(oData, oRowInfo){
		...
		if (this.isValid(retVal)) {
			...
			Log.warning("UlcClipingPath shape generated invalid d: " + retVal + " from the given data: " + oData);
			return null;
		}
	};
