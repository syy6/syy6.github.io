 ...
 */
sap.ui.define([
	"sap/base/Log", "sap/gantt/shape/Path", "sap/ui/core/Core"
], function (Log, Path, Core) {
	"use strict";
	/**
	...
	Relationship.prototype.getD = function (oData, oRowInfo) {
		...
		try {
			...
			Log.warning("invalid relationship type");
		}
		...
		if (this.isValid(dStr)) {
			...
			Log.warning("Relationship shape generated invalid d: " + dStr + " from the given data: " + oData);
			return null;
		}
	};
