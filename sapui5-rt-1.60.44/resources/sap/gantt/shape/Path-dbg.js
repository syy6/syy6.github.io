 ...
 */
sap.ui.define([
	"sap/base/Log", "sap/gantt/shape/Shape", "sap/gantt/misc/Utility"
], function (Log, Shape, Utility) {
	"use strict";
	...
	Path.prototype.getD = function (oData, oRowInfo) {
		...
		if (this.isValid(sD)) {
			...
			Log.warning("Path shape generated invalid d: " + sD + " from the given data: " + oData);
			return null;
		}
	};
