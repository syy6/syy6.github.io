...
sap.ui.define([
...
], function (Measurement, Parameters) {
	"use strict";
	...
	ListLegendRenderer.render = function (oRenderManager, oLegend) {
		Measurement.start("ListLegendRenderer render","GanttPerf:ListLegendRenderer render function");
		...
		Measurement.start("ListLegendRenderer renderPaintServer","GanttPerf:ListLegendRenderer renderPaintServer part");
		this.renderSvgDefs(oRenderManager, oLegend);
		Measurement.end("ListLegendRenderer renderPaintServer");
		...
		oRenderManager.write("</div>");
		Measurement.end("ListLegendRenderer render");
	};
