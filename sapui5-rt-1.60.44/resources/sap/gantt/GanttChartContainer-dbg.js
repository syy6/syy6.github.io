...
function (
	...
	GanttChartContainer.prototype.init = function () {
		Measurement.start("GanttChartContainer Init","GanttPerf:GanttChartContainer Init function");
		...
		Measurement.end("GanttChartContainer Init");
	};
	...
	GanttChartContainer.prototype._insertGanttChart = function (oGanttChart, bReadConfig, iIndex) {
		Measurement.start("GanttChartContainer _insertGanttChart","GanttPerf:GanttChartContainer _insertGanttChart function");
		if (!oGanttChart) {
			return;
		}
		...
		Measurement.end("GanttChartContainer _insertGanttChart");
	};
