 ...
 */
sap.ui.define([
	"sap/ui/thirdparty/jquery", "sap/ui/Device", "sap/ui/base/Object"
		...
		if (oZoomStrategy.getMouseWheelZoomType() !== sap.gantt.MouseWheelZoomType.None) {
			...
			if ((!bZoomIn && oZoomStrategy.getZoomLevel() > 0 ) || (bZoomIn && oZoomStrategy.getZoomLevel() < oZoomStrategy.getZoomLevels() - 1)) {
				...
				if (iTimerDelay === 0) {
					...
					this._iMouseWheelZoomTimer = this._iMouseWheelZoomTimer
					|| window.setTimeout(this._updateVisibleHorizon.bind(this), iTimerDelay, oEvent, iScrollDelta, bSuppressSyncEvent);
				}
