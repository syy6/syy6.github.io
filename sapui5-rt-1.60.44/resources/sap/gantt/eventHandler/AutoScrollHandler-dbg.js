 ...
 */
sap.ui.define([
	'sap/ui/thirdparty/jquery', 'sap/ui/core/Element', "sap/ui/core/Core"
	...
	AutoScrollHandler.prototype.autoScroll = function (oGanttChart, oEvent) {
		...
		if ($svgCtn.offset()){
			...
			if (oEvent.pageX - iSvgLeft > 0 && oEvent.pageX - iSvgLeft < iHorizontalThreshold) {
				...
				this._iAutoScrollTimeout = window.setInterval(function() {
	...
	AutoScrollHandler.prototype.stop = function () {
		window.clearInterval(this._iAutoScrollTimeout);
	};
