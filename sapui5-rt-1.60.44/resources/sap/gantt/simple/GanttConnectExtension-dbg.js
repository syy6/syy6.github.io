...
sap.ui.define([
	...
	"./CoordinateUtils",
	"./GanttUtils"
], function(jQuery, KeyCodes, Core, library, GanttExtension, CoordinateUtils, GanttUtils) {
	"use strict";
	...
	GanttConnectExtension.prototype.fireEvent = function(oEvent) {
		...
		var oEventData = {
			...
			toShapeUid: jQuery(document.getElementById(sToShapeId)).control(0).getShapeUid(),
	...
	GanttConnectExtension.prototype.onKeydown = function(oEvent) {
		if (this.isShapeConnecting() && oEvent.keyCode === KeyCodes.ESCAPE) {
