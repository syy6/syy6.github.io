...
sap.ui.define([
	...
	BaseRectangle.prototype.init = function() {
		BaseShape.prototype.init.apply(this, arguments);
		// This need to indicate any invalid properties calculated via binding
		// skip rendering if necessary
		this.bHasInvalidPropValue = false;
	};
