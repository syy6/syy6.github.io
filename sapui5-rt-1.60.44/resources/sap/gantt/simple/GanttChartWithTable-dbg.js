...
sap.ui.define([
	...
	var GanttChartWithTable = Control.extend("sap.gantt.simple.GanttChartWithTable", /** @lends sap.ui.core.Control.prototype */ {
		metadata: {
			...
			events: {
				...
				/**
				 * Event fired when a shape is hovered.
				 */
				shapeMouseEnter: {
					parameters: {
						/**
				...
				/**
				 * Fired when mouse leave the shape.
				 */
				shapeMouseLeave: {
					parameters: {
						/**
				...
				/**
				 * Event fired when a shape is double clicked
				 */
				shapeDoubleClick: {
					parameters:{
						shape: {type: "sap.gantt.shape.BaseShape"},
				...
				/**
				 * Event fired when you right click (context menu) on a shape
				 */
				shapeContextMenu: {
					parameters:{
						shape: {type: "sap.gantt.shape.BaseShape"},
	...
	GanttChartWithTable.prototype.setTable = function(oTable) {
		...
		// Enablre the variable row height feature (half row scrolling)
	...
	GanttChartWithTable.prototype.exit = function() {
		...
		delete this._bInitialRenderPassed;
	};
