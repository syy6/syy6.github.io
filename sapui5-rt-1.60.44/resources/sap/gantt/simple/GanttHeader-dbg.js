...
sap.ui.define([
	...
	GanttHeader.prototype.renderElement = function() {
		...
		var $HeaderPlaceHolder = jQuery("div.sapGanttChartWithTableHeader[data-sap-ui-related=" + sGanttId + "]");
		...
		var nHalfHeight        = iHeaderHeight / 2,
			nfirstRowYOffset   = iHeaderHeight / 5 * 2,
			nMiddleLineYOffset = iHeaderHeight / 5 * 4,
			nSecondRowYOffset  = iHeaderHeight / 5 * 4;
