...
sap.ui.define([
	...
	var GanttPointerHelper = {
		addEventListeners: function(oGantt) {
			...
			jQuery("body #" + oGantt.getId()).on(sMousemoveEventWithNamespace, CoordinateUtils.updateCursorPosition);
		},
	...
	GanttPointerExtension.prototype.getAutoScrollPosition = function() {
		...
		var iCurrentScrollTriggerAreaWidth = 10,
			...
			oCurrentScrollArea = window.document.getElementById(this.getGantt().getId() + "-gantt"),
