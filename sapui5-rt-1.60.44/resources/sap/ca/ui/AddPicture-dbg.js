...
sap.ca.ui.AddPicture.M_EVENTS = {'show':'show','pictureAdded':'pictureAdded','maxPictureLimitReached':'maxPictureLimitReached','imageUploadFailed':'imageUploadFailed','fileNotSupported':'fileNotSupported'};
 ...
 * Image upload failed, only supports image format files
 *
 * @name sap.ca.ui.AddPicture#fileNotSupported
 * @event
 * @param {sap.ui.base.Event} oControlEvent
 * @param {sap.ui.base.EventProvider} oControlEvent.getSource
 * @param {object} oControlEvent.getParameters
 ...
 * @return {sap.ca.ui.AddPicture} <code>this</code> to allow method chaining
 * @public
 * @name sap.ca.ui.AddPicture#attachFileNotSupported
 * @function
 */
 ...
 * @return {sap.ca.ui.AddPicture} <code>this</code> to allow method chaining
 * @public
 * @name sap.ca.ui.AddPicture#detachFileNotSupported
 * @function
 */
 ...
 * @return {sap.ca.ui.AddPicture} <code>this</code> to allow method chaining
 * @protected
 * @name sap.ca.ui.AddPicture#fireFileNotSupported
 * @function
 */
