...
sap.ui.define([
    ...
    module.Tester.prototype = {
        ...
        init: function (sSearchTerms, highlightStyle, matchContains, bDisjunctionType) {
            ...
            for (var j = 0; j < this.aSearchTerms.length; ++j) {
                ...
                var bIsChinese = searchTerm.match(/[\u3400-\u9faf]/) !== null ? true : false;
        ...
        setFocus: function () {
            ...
            var doSetFocus = function () {
                ...
                if (!sap.ui.getCore().byId('Fiori2LoadingDialog')) {
                    if (!controlDomRef || jQuery('.sapMBusyDialog').length > 0) {
                        if (--retries) {
    ...
    module.openURL = function (URL, target) {
        if (WindowUtils && WindowUtils.openURL) {
            return WindowUtils.openURL(URL, target);
        }
