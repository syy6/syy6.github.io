...
sinaDefine([
        ...
        './AttributeType',
        './AttributeFormatType',
        './AttributeDescriptionTextArrangement',
        './DataSourceType',
        './SuggestionType',
        ...
        './formatters/DefaultResultSetFormatter'
    ],
    function (
        core,
        util,
        ...
        return core.defineClass({
            ...
            AttributeDescriptionTextArrangement: AttributeDescriptionTextArrangement,
            ...
            _init: function (provider) {
                ...
                this.searchResultSetFormatters.push(new DefaultResultSetFormatter());
            },
