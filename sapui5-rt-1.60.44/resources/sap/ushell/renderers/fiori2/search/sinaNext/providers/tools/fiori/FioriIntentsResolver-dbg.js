...
sinaDefine([
    ...
    return SinaObject.derive({
        ...
        _doResolveIntents: function (vArgs) {
            ...
            if (systemId && systemId.trim().length > 0 && client && client.trim().length > 0 &&
                (!that._fioriFrontendSystemInfo || !(that._fioriFrontendSystemInfo.systemId == systemId && that._fioriFrontendSystemInfo.client == client))) {
