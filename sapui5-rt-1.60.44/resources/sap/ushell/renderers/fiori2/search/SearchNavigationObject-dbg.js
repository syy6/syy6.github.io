...
sap.ui.define(['sap/ushell/renderers/fiori2/search/eventlogging/EventLogger', 'sap/ushell/renderers/fiori2/search/SearchHelper'], function (EventLogger, SearchHelper) {
    "use strict";
    ...
    return sap.ui.base.Object.extend("sap.ushell.renderers.fiori2.search.SearchNavigationObject", {
        ...
        performNavigation: function (properties) {
            ...
            if (!this._target) {
                SearchHelper.openURL(this._href);
            } else {
                SearchHelper.openURL(this._href, this._target);
            }
        },
