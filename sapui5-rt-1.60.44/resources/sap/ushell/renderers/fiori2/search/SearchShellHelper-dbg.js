    ...
    jQuery.extend(module, {
            ...
            that.oSearchInput.addEventDelegate({
                ...
                onAfterRendering: function () {
                    ...
                    $input.on('blur', that.makeDelayed(function (event) {
                        ...
                        if (picker) {
                            if (picker.oPopup.eOpenState === "OPENING") {
                                return;
                            }
                        }
            ...
            that.oSearchSelect.addEventDelegate({
                onAfterRendering: function () {
                    ...
                    domRef.addEventListener('blur', that.makeDelayed(function (event) {
                        ...
                        if (that.oSearchInput.getValue().length === 0 && model.getDataSource() === model.getDefaultDataSource()) {
                            that.setSearchState('COL');
                        } else {
                            that.setSearchState('EXP_S');
                        }
        ...
        setSearchState: function (state, showOverlay) {
            ...
            case 'COL':
                ...
                break;
            case 'EXP_S':
                // this.oModel.abortSuggestions(); // prevent empty suggestion popover after soft keyboard hidden on iPad
                this.oShellHeader.setSearchState(state, 35, showOverlay);
