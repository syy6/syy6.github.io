...
sap.ui.define([
    ...
    return sap.ui.jsview("sap.ushell.renderers.fiori2.search.container.Search", {
        ...
        createContent: function (oController) {
            ...
            sap.ui.getCore().byId('ushell-search-result-count-label').setLabelFor(that.searchLayout);
        ...
        assembleCountLabel: function () {
            ...
            var label = new sap.m.Label('ushell-search-result-count-label', {
                visible: {
                    parts: [{
                        path: '/count'
                    }],
        ...
        determineIfMaps: function (oContext) {
            ...
            if (oContext.getModel()) {
                if (oContext.getModel().config.maps) {
                    bIfMaps = true;
                }
        ...
        assembleCenterArea: function () {
            ...
            //            that.searchResultTable.attachUpdateFinished(function(){
            //                that.updateTableLayout();
            //            });
