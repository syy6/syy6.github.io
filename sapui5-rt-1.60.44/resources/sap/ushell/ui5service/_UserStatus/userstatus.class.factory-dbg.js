sap.ui.define(["sap/ui/base/EventProvider", "sap/ushell/ui/launchpad/UserStatusItem"], function (EventProvider, UserStatusItem) {
    "use strict";
        ...
        var UserStatus = Service.extend("sap.ushell.ui5service.UserStatus", /** @lends sap.ushell.ui5service.UserStatus# */ {
            ...
            _showLegalPopup: function () {
                ...
                setTimeout(function () {
                    ...
                    var signInAsPopOver = that._getOnlineStatusPopOver(UserStatusItem.prototype.STATUS_ENUM.AVAILABLE.status);
