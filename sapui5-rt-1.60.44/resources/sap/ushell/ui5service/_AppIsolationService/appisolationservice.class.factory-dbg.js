sap.ui.define(
    [
        ...
        'sap/ushell/EventHub'
    ], function (EventProvider, EventHub) {
    "use strict";
    ...
    return function (oSettings) {
        ...
        var AppIsolationService = Service.extend("sap.ushell.ui5service.AppIsolationService", /** @lends sap.ushell.ui5service.AppIsolationService# */ {
            ...
            registerShellCommunicationHandler: function (oCommunicationHandlers, sAppType) {
                oAppLifeCycle.registerShellCommunicationHandler(oCommunicationHandlers, sAppType);
            },
