            ...
            loadScripts([
                ...
                sap.ui.require([
                    "sap/ushell/bootstrap/appfinder/appFinder-dev"
                        ...
                        // the core must be loaded after the cdm-def-dev because
                        // cdm-def-dev needs to set the configuration to core first
                        // before core can be loaded
                        //
                        // load core and finally boot the core
