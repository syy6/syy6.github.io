sap.ui.define([
...
], function (Object, utils, Hub, ClientSideTargetResolution) {
    ...
    var mPlatformPackages,
        ...
        // could be replaced by other mechanism going forward
        // maybe use plattform defaultds for this....
        oConfig = {
            services: {
                Personalization : {
                    adapter: {
    ...
    var oAdapter = {
        getSystem: function () { return oSystem; }
    };
