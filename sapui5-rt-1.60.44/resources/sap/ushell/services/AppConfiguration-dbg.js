...
sap.ui.define([
    ...
    function AppConfiguration() {
        ...
        /**
         * Returns the current application, excluding the home page and the
         * appfinder (which are FLP Core components).
         *
         * @returns {object}
         *   a copy of the metadata object related to the application, or null
         *   if no application is currently opened (e.g., when home or app
         *   finder are opened).
         *
         * @private
         */
        this.getCurrentAppliction = function () {
        ...
        this.setHeaderHiding = function () {
            jQuery.sap.log.warning("Application configuration headerHiding property is deprecated and has no effect");
        };
        ...
        this.setApplicationFullWidth = function (bValue) {
            sap.ushell.components.applicationIntegration.AppLifeCycle.setApplicationFullWidth(bValue);
        };
