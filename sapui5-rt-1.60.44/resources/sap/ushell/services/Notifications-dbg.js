...
], function (OData, SapPcpWebSocket) {
    "use strict";
            ...
            OData.request(oRequestObject,
                function (oResult) {
                    ...
                    if (oResult.response && oResult.response.statusCode === 200) {
                        ...
                        oDeferred.reject();
                        jQuery.sap.log.error("Notification service - oData executeBulkAction failed", "sap.ushell.services.Notifications");
                    }
                });
        ...
        */
        ...
        this._establishWebSocketConnection = function () {
            ...
            try {
                ...
                oWebSocket.attachMessage(this, function(oMessage) {
