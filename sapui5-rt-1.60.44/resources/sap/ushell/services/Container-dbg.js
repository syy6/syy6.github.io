...
sap.ui.define([
    ...
    'jquery.sap.global',
    'jquery.sap.mobile'
], function (utils, System, oUi5ServiceFactory, EventProvider, ServiceFactoryRegistry, Control, jQuery) {
    "use strict";
     ...
     *     if true, the adapter is loaded asynchronously and a Promise is returned
     *     @experimental Since version 1.55.0.
     * @returns {object|Promise}
     *     the adapter or, in asynchronous mode, a Promise that returns the adapter
     */
    ...
    function Container(oAdapter) {
         ...
         * @experimental Since version 1.55.0.
         * @returns {sap.ui.core.Control|Promise}
         *     the renderer or Promise (in asynchronous mode)
         *
         * @methodOf sap.ushell.services.Container#
         * @name createRenderer
         * @since 1.15.0
        ...
        this.createRenderer = function (sRendererName, bAsync) {
            ...
            function getRendererInstance() {
                var oRenderer = new (jQuery.sap.getObject(sComponentName))({
                    componentData: oComponentData
                });

                var oShellControl = oRenderer instanceof sap.ui.core.UIComponent ?
       ...
       /**
         ...
         *     @experimental Since version 1.55.0.
         * @returns {object|Promise}
         *     the service or, in asynchronous mode, a Promise that returns the service
         *
         * @methodOf sap.ushell.services.Container#
         * @name getService
        ...
        this.getService = function (sServiceName, sParameter, bAsync) {
            ...
            function createService(ServiceClass, oServiceAdapter) {
                ...
                return new ServiceClass(oServiceAdapter, oContainerInterface, sParameter,
                    oServiceProperties);
            }
         ...
         *     constructor.
         * @returns {Promise}
         *     a Promise that returns the requested service
         *
         * @methodOf sap.ushell.services.Container#
         * @name getServiceAsync
         * @see sap.ushell.services.ContainerInterface
         * @since 1.55.0
         * @public
         * @experimental
         * @alias sap.ushell.services.Container#getServiceAsync
         */
        ...
        */
         ...
         * @since 1.56
         * @private
         * @alias sap.ushell.services.Container#getFLPUrl
         */
         ...
         *
         * @returns {object}
         *      An object containing the exposed functions.
         *
         * @name _unitTestsAccess
         * @private
         */
    ...
    sap.ushell.bootstrap = function (sPlatform, mAdapterPackagesByPlatform) {
        ...
        createAdapter("Container", system, null, true /* async */).then(function (adapter) {
            adapter.load().then(function () {
                ...
                if (_bLoadCDM()) {
                    asyncServices.push(sap.ushell.Container.getServiceAsync("CommonDataModel"));
                }
                Promise.all(asyncServices).then(
                    function (aServices) {
