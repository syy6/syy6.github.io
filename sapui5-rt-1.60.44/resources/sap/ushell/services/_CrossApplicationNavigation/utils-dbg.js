...
sap.ui.define([], function () {
     ...
     * @private
     */
    function safeParseToObject (sObject) {
        try {
     ...
     * @private
     */
    function createAppStateFromData (oData) {
     ...
     * @private
     */
    function extractParameter (vIntent, sParameterName) {
        ...
        if (Object.prototype.toString.apply(vIntent) === "[object Object]") {
            ...
            if (typeof sShellHash === "string") {
                var oResult = extractParameter(sShellHash, sParameterName);
     ...
     */
    function addXAppStateFromParameter (vIntent, sSourceParameter) {
        ...
        oXAppStateDataExtraction = extractParameter(vIntent, sSourceParameter);
        ...
        oAppStateData = safeParseToObject(sXAppStateData);
        if (!oAppStateData) {
            return;
        }

        sAppStateKey = createAppStateFromData(oAppStateData);

        injectParameter(vIntentNoXAppStateData, "sap-xapp-state", sAppStateKey);
    }
     ...
     * @private
     */
    function injectParameter (vIntent, sParameterName, vParameterValue) {
        if (typeof vIntent === "string") {
        ...
        if (Object.prototype.toString.apply(vIntent) === "[object Object]") {
            var sShellHash = jQuery.sap.getObject("target.shellHash", undefined, vIntent);
            if (typeof sShellHash === "string") {
                vIntent.target.shellHash = injectParameter(
    ...
    return {
        ...
        safeParseToObject: safeParseToObject,
        createAppStateFromData: createAppStateFromData,
        addXAppStateFromParameter: addXAppStateFromParameter
    };
