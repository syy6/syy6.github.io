...
], function (resources, ResourceModel, GenericTile, ImageContent, TileContent, NumericContent, mobileLibrary, ComponentContainer, OData, WindowUtils) {
    "use strict";
            ...
            if (oEvent.getSource().getScope && oEvent.getSource().getScope() === "Display") {
                if (oTileData.properties.targetURL) {
                    if (oTileData.properties.targetURL[0] === '#') {
                        ...
                        oRecentEntry.title = oTileData.properties.title;
                        oRecentEntry.appType = "App";
                        oRecentEntry.url = oTileData.properties.targetURL;
                        oRecentEntry.appId = oTileData.properties.targetURL;

                        renderer.logRecentActivity(oRecentEntry);
