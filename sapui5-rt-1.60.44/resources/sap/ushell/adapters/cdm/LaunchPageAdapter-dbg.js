...
sap.ui.define( [
    ...
    "sap/ushell/adapters/cdm/_LaunchPage/readCatalogs",
    "sap/m/GenericTile",
    "sap/m/library",
    ...
    oReadHomePageUtils,
    oModifyHomePageUtils, // TODO should be loaded lazy only when really needed (e.g. in moveTile)
    oReadCatalogUtils, // TODO should be loaded lazy only when really needed
    GenericTile,
    oMobileLibrary,
    ComponentContainer,
    fnUriTransform,
                    ...
                    .done(function (oSite) {
                        ...
                        oReadHomePageUtils.getGroupsArrayFromSite(oSite).forEach(function (oGroup) {
                            oModifyHomePageUtils.setGroupVisibility(oGroup,
                                // group is not in list of hidden groups -> visiblity === true
                                jQuery.inArray(oReadHomePageUtils.getGroupId(oGroup), aHiddenGroupIds) === -1
                            );
                        });
            ...
            if (oResolutionResult.indicatorDataSource) {
                ...
                if (oResolutionResult.indicatorDataSource.hasOwnProperty("dataSource")) {
                    ...
                    if (oDataSources && oDataSources.hasOwnProperty(sDataSourceName)) {
                        oResult.dataSource = oDataSources[sDataSourceName];
                    } else {
                ...
                if (oUshellUtils.getMember(oResolutionResult, "runtimeInformation.componentProperties.url")) {
                    ...
                    var oTransformed =
                        fnUriTransform( sPathIndicatorDataSource, sUriDataSource, sUrlComponent, window.location.href );
    ...
    /**
        ...
        this._getTileUiComponentContainerSync = function (oTile, oResolvedTile, bIsCatalogTile) {
            ...
            if (oConfig.name) {
                ...
                oCompContainer =  new sap.ui.core.ComponentContainer({
