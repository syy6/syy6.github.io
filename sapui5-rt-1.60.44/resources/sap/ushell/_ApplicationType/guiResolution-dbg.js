...
sap.ui.define([
...
], function (URI, oUtils, oApplicationTypeUtils, oSystemAlias, oCSTRUtils, oParameterMapping) {
    "use strict";
    ...
    function injectEffectiveParametersIntoWebguiQueryParam (sTransactionQueryParam, oParamsToInject) {
        ...
        return oParsedTransactionQueryParam.transactionParamName + "=" + (bHasParameters && bAllwaysShowSelScreen
            ? "*" : "") + oParsedTransactionQueryParam.transactionCode + (bHasParameters ? "%20" : "")
    ...
    function resolveEasyAccessMenuIntentWebgui (oIntent, oMatchingTarget, fnExternalSystemAliasResolver) {
        ...
        return new Promise(function (fnResolve, fnReject) {
            ...
            buildNativeWebGuiURI( oIntent.params["sap-ui2-tcode"][0], oIntent.params["sap-system"][0], sSapSystemDataSrc, fnExternalSystemAliasResolver)
                .done(function (oURI) {
