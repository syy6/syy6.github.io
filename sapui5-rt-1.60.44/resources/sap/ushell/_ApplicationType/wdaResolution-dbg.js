...
sap.ui.define([
...
], function (URI, oUtils, oApplicationTypeUtils, oSystemAlias) {
    "use strict";
    ...
    function constructFullWDAResolutionResult (oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver) {
        var oInboundResolutionResult = jQuery.sap.getObject("inbound.resolutionResult", undefined, oMatchingTarget),
