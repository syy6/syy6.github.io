sap.ui.define(
    [
        ...
        'sap/ushell/EventHub',
        'sap/ushell/library'
    ], function (jQuery, Control, IconPool, EventHub) {
    "use strict";
    ...
    /**
     * Uses sap.ushell.EventHub to signal that a ToolAreaItem was created via Event
     * "ToolAreaItemCreated"
    */
    ...
    ToolAreaItem.prototype.init = function () {
        EventHub.emit("ToolAreaItemCreated");
    };
