 ...
 */
sap.ui.define(['sap/m/Button', 'sap/ui/core/IconPool', 'sap/ushell/library'], function (Button, IconPool) {
        "use strict";
        ...
        var ShellTitle = Button.extend("sap.ushell.ui.shell.ShellTitle",
            {
                ...
                renderer: {
                    render:  function (oRm, oControl) {
                        ...
                        if (oInnerControl) {
                            oRm.write("<button tabindex='0'");
                            oRm.addClass("sapUshellShellHeadAction sapUshellShellHeadActionButton sapUshellHideIconOnDesktop");
                            oRm.writeClasses();
                            ...
                            oRm.write("</span><span class='sapUshellShellHeadActionExp'></span></button>");
                        } else {
        ...
        ShellTitle.prototype.getDomRef = function () {
            var buttonRef = document.getElementById("shell-header-hdr-shell-title");
            if (buttonRef) {
                return buttonRef;
            } else {
                return Button.prototype.getDomRef.call(this);
            }
        };
