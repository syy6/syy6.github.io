...
/*global jQuery, sap */
sap.ui.define(['jquery.sap.global', 'sap/ushell/library', 'sap/ui/Device', 'sap/ushell/EventHub'], function (jQuery, library, Device, EventHub) {
        "use strict";
        ...
        FloatingContainer.prototype._handleResize = function (oEvent) {
            ...
            var sDevice = Device.media.getCurrentRange(sap.ui.Device.media.RANGESETS.SAP_STANDARD);
            if (sDevice.name != "Desktop" && (jQuery('.sapUiMedia-Std-Desktop').width() - 416 < sDevice.from) && (jQuery('.sapUshellContainerDocked').size())) {
                ...
                jQuery('#shell-header').removeClass('sapUshellContainerDockedLaunchpad');
                if (jQuery('#canvas').hasClass('sapUshellContainer-Narrow-Right')) {
                    jQuery('#canvas').removeClass('sapUshellContainer-Narrow-Right sapUshellMoveCanvasRight sapUshellContainerDockedLaunchpad openRight');
                } else {
                    jQuery('#canvas').removeClass('sapUshellContainer-Narrow-Left sapUshellMoveCanvasLeft sapUshellContainerDockedLaunchpad openLeft');
                }
