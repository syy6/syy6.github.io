...
sap.ui.define(['jquery.sap.global', 'sap/ui/core/Control', 'sap/ui/core/IconPool', 'sap/ushell/library'], function (jQuery, Control, IconPool) {
        "use strict";
        ...
        var ShellHeadItem = Control.extend("sap.ushell.ui.shell.ShellHeadItem", /** @lends sap.ushell.ui.shell.ShellHeadItem.prototype */ {
            metadata: {
                ...
                properties: {
                    ...
                    /**
                     * AccessKey for browser accessability
                     * @since 1.62
                     */
                    accessKey: {
                        type: "string",
            ...
            renderer: {
                render: function (rm, oItem) {
                    var sAccessKey = oItem.getAccessKey();
                    ...
                    if (sAccessKey) {
                        rm.writeAttributeEscaped("accesskey", sAccessKey);
                    }
