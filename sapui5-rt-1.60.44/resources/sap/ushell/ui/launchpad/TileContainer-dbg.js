...
sap.ui.define([
    ...
    function (jQuery, ManagedObject, Control, library, Icon, Text, override, resources, PlusTile /*, TileContainerRenderer */) {
        "use strict";
...
var TileContainer = Control.extend("sap.ushell.ui.launchpad.TileContainer", /** @lends sap.ushell.ui.launchpad.TileContainer.prototype */ { metadata : {
	...
	properties : {
        ...
        /**
		 */
		homePageGroupDisplay : {type : "string", defaultValue : null},
        ...
        if (isVisibleTiles) {
            ...
            if (this.getShowNoData()) {
                if (this.getNoDataText()) {
                    ...
                    this.setNoDataText(resources.i18n.getText("noFilteredItems"));
                }
 ...
 */
        ...
        TileContainer.prototype.isLinkPersonalizationOveride = function () {
            ...
            TileContainer.prototype.destroyLinks = function (sReason) {
                jQuery.sap.log.debug("link is destroyed because: " + sReason, null, "sap.ushell.ui.launchpad.TileContainer");
            };
    };
