...
sap.ui.define([
...
], function (ManagedObject, Control, ResizeHandler, library, override, utils, Config, Device) {
    "use strict";
    ...
    DashboardGroupsContainer.prototype._updateTileContainer = function (refresh) {
        ...
        var iTileWidth = oTileDimensions.width + oTileDimensions.marginEnd;

        var iMaxTilesPerRow = Math.floor(oContainerDimensions.width / iTileWidth);
