...
sap.ui.define(['sap/m/Button', 'sap/ushell/library', 'sap/ushell/resources', 'sap/collaboration/components/fiori/sharing/dialog/Component', './JamShareButtonRenderer'], function (Button, library, resources, Component) {
        "use strict";
        ...
        JamShareButton.prototype.showShareDialog = function (cb) {
            ...
            if (sap.ushell.Container && sap.ushell.Container.runningInIframe && sap.ushell.Container.runningInIframe()) {
                ...
                oPromise.then(function () {
                    ...
                    jQuery.sap.log.error("Could not retrieve FLP URL", sError,
