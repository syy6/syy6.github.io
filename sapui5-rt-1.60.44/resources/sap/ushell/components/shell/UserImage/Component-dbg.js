...
sap.ui.define([
    ...
    'sap/ui/Device',
    'sap/base/Log'],
function (resources, UIComponent, ComponentKeysHandler, utils, Dialog, Button, Text, Link, VerticalLayout, FlexBox, IconPool, Device, logger) {
        ...
        * */
        _setUserImage: function (param) {
            ...
            if (sUrl && typeof sUrl === 'string') {
                isEmptyUrl = false;
            } else if (!jQuery.isEmptyObject(sUrl)){
                isEmptyUrl = false;
            }
