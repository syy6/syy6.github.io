...
sap.ui.define(['sap/ui/core/UIComponent'],
     ...
     * });
         ...
         * @public
         */
        API.prototype.showActionButton = function (aIds, bCurrentState, aStates, bIsFirst) {
            var aButtons = [],
                aActions = [],
                oButton;
            if (typeof aIds === "string") {
     ...
     * ]});
         ...
         * @private
         */
        API.prototype.toggleOverFlowActions = function(){
     ...
     *     };
         ...
         * @public
         */
        API.prototype.addActionButton = function (controlType, oControlProperties, bIsVisible, bCurrentState, aStates, bIsFirst) {
     ...
     *           }, true, false, ["home"]);
        ...
        /*---------------Generic--------------------*/
        API.prototype.convertButtonsToActions = function (aIds, bCurrentState, aStates, bIsFirst){
            var oProperties = {},
                oButton,
                that = this;
