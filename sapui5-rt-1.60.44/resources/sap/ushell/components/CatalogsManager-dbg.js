...
sap.ui.define([
    ...
    function (BaseObject, TileState, oEventHub, oUtils, oDestroyHelper, oGroupsHelper, oMessagingHelper, HomepageManager) {
        "use strict";
        ...
        var CatalogsManager = BaseObject.extend("sap.ushell.components.CatalogsManager", {
            ...
            constructor: function (sId, mSettings) {
                ...
                sap.ushell.components.getCatalogsManager = jQuery.sap.getter(this.getInterface());
                this.registerEvents();
            },
            ...
            onDoneLoadingCatalogs: function (aCatalogs) {
                ...
                /*            aCurrentCatalogs = this.oModel.getProperty('/catalogs');
                 ...
                 title: oMessagingHelper.getLocalizedText("catalogSelect_initial_selection"),
                 "static": true,
                 tiles: [],
            ...
            createTile: function (oData) {
                ...
                if (!oCatalogTileContext) {
                    jQuery.sap.log.warning("CatalogsManager: Did not receive catalog tile object. Abort.", this);
