...
sap.ui.define(["sap/ui/base/Object", "sap/ui/Device", "sap/ushell/Config"], function (BaseObject, Device, Config) {
	"use strict";
    ...
    var PagingManager = BaseObject.extend("sap.ushell.components._HomepageManager.PagingManager", {
        metadata : {
            publicMethods : ["setElementClass", "GetGroupHeight", "setContainerSize", "getNumberOfAllocatedElements", "moveToNextPage", "getTileHeight"]
        },
        constructor : function (sId, mSettings) {
            //make this class only available once
//            if (sap.ushell.components._HomepageManager.getPagingManager && sap.ushell.components._HomepageManager.getPagingManager()) {
//                return sap.ushell.components._HomepageManager.getPagingManager();
//            }
            sap.ushell.components._HomepageManager.getPagingManager = jQuery.sap.getter(this.getInterface());
