...
sap.ui.define(['sap/m/TileContainer', 'sap/ushell/library'],
	function (TileContainer, library) {
	"use strict";
 ...
 */
var PictureViewer = TileContainer.extend("sap.ushell.components.factsheet.controls.PictureViewer", /** @lends sap.ushell.components.factsheet.controls.PictureViewer.prototype */ { metadata : {
