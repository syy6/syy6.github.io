sap.ui.define(['sap/ushell/components/factsheet/tools/ODataUrlTemplating', 'sap/ushell/components/factsheet/factory/ThingInspector', 'sap/ui/model/odata/ODataUtils'],
    function (ODataUrlTemplating, ThingInspector, ODataUtils) {
	"use strict";
    ...
    sap.ui.jsview("sap.ushell.components.factsheet.views.ThingViewer", {
        ...
        createContent : function (oController) {
            ...
            sServiceUrl = amendServiceUrlWithSapSystemIfRequired(sap.ui.core.Component.getOwnerComponentFor(this), sServiceUrl);
