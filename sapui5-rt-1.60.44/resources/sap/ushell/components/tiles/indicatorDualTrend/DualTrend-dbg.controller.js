  ...
  /*eslint-disable no-lonely-if*/
	...
	sap.ui.controller("tiles.indicatorDualTrend.DualTrend", {
		...
		logError: function (err) {
			this.oDualTrendView.oGenericTile.setState(sap.m.LoadState.Failed);
			this.oDualTrendView.oGenericTile.setState(sap.m.LoadState.Failed);
					...
					try {
						...
						this.trendChartODataReadRef = oQuery.model.read(oQuery.uri, null, null, true, function (data) {
							if (data && data.results && data.results.length){
								...
								that.oDualTrendView.oGenericTile.setState(sap.m.LoadState.Loaded);
		...
		onInit: function () {
			...
			this.oDualTrendView.oGenericTile.setState(sap.m.LoadState.Loading);
			if (this.oTileApi.preview.isEnabled()) {
				...
				this.oDualTrendView.oGenericTile.setState(sap.m.LoadState.Loaded);
			} else {
				try {
