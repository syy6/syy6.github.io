...
sap.ui.define([
...
], function (OData, URI, utils, utilsRT, AppLifeCycle, Config, GenericTileMode, WindowUtils) {
    "use strict";
    ...
    sap.ui.controller("sap.ushell.components.tiles.applauncherdynamic.DynamicTile", {
            ...
            if (oEvent.getSource().getScope && oEvent.getSource().getScope() === sap.m.GenericTileScope.Display) {
                if (oTileApi.configurationUi.isEnabled()) {
                    ...
                    if (sTargetUrl[0] === '#') {
                        ...
                        oRecentEntry.title = oConfig.display_title_text;
                        oRecentEntry.appType = "App";
                        oRecentEntry.url = oConfig.navigation_target_url;
                        oRecentEntry.appId = oConfig.navigation_target_url;
        ...
        onSaveConfiguration: function (oConfigurationView) {
            ...
            var oDeferred = jQuery.Deferred(), // eslint-disable-line
        ...
        successHandlerFn: function (sRequestUrl, oResult) {
            ...
            if (typeof oResult === "object") {
                ...
                var uriParamInlinecount = jQuery.sap.getUriParameters(sRequestUrl).get("$inlinecount");
