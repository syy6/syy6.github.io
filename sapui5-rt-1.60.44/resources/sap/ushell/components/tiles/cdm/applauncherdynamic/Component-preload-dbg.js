sap.ui.require.preload({
	"sap/ushell/components/tiles/cdm/applauncherdynamic/Component.js":function(){// ${copyright}
/* global jQuery, sap */
sap.ui.define([
	...
	"sap/ushell/components/tiles/cdm/applauncherdynamic/DynamicTile.controller.js":function(){// ${copyright}
sap.ui.define([
...
], function (Controller, utils, NumberFormat, Config, OData, URI, WindowUtils) {
    "use strict";

    /*global jQuery, sap, setTimeout, hasher */
        ...
        onPress: function (oEvent) {
            ...
            if (oEvent.getSource().getScope && oEvent.getSource().getScope() === sap.m.GenericTileScope.Display) {
                ...
                if (!sTargetURL) {
                    ...
                    oRecentEntry.title = sTitle;
                    oRecentEntry.appType = "App";
                    oRecentEntry.url = sTargetURL;
                    oRecentEntry.appId = sTargetURL;
	...
	"sap/ushell/components/tiles/cdm/applauncherdynamic/DynamicTile.view.js":function(){// ${copyright}
