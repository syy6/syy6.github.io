...
(function() {
	...
	jQuery.sap.require('sap.ui.util.openWindow');
	sap.ui.controller("sap.apf.modeler.ui.controller.configurationList", {
		...
		handleExecuteButtonPress : function() {
			...
			var executeConfiguration = function() {
				...
				var openWindow = sap.ui.require("sap/ui/util/openWindow");
				this.oCoreApi.navigateToGenericRuntime(oParentNodeDetails.appId, oParentNodeDetails.configId, openWindow);
