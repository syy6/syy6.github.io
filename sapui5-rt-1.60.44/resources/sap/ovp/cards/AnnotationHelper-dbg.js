 ...
 */
sap.ui.define(["jquery.sap.global", "sap/ui/core/format/NumberFormat", "sap/ui/core/format/DateFormat",
        "sap/ovp/cards/CommonUtils", "sap/ui/model/odata/AnnotationHelper",
        "sap/ui/model/FilterOperator", "sap/ui/Device",
        "sap/ui/model/analytics/odata4analytics", "sap/ui/vbm/library", "sap/ui/generic/app/navigation/service/SelectionVariant", "sap/ovp/app/resources"],
    function (jQuery, NumberFormat, DateFormat, CommonUtils, OdataAnnotationHelper,
              FilterOperator, Device, odata4analytics, VbmLibrary, SelectionVariant, OvpResources) {
                ...
                if (oEntityTypeProperty["type"] === 'Edm.DateTime' || oEntityTypeProperty["type"] === 'Edm.DateTimeOffset') {
                    ...
                    if (oEntityTypeProperty["Org.OData.Measures.V1.ISOCurrency"]) {
                        ...
                        if (oCurrency.Path) {
                            ...
                            functionName = getCurrencyFormatFunctionName(iScale, iScaleFactor, oCurrency.String);
        ...
        function getNumberFormatFunctionName(numberOfFractionalDigits,iScaleFactor) {
            var functionName = "formatNumberCalculation_" + (iScaleFactor ?  numberOfFractionalDigits + "_" + iScaleFactor : numberOfFractionalDigits);
         ...
         * @returns {string}
         */
        function getCurrencyFormatFunctionName(iNumberOfFractionalDigits,iScaleFactor, sCurrency) {
            var sValueFormatFromAnnotation = iScaleFactor ? iNumberOfFractionalDigits + "_" + iScaleFactor : iNumberOfFractionalDigits;
            var functionName = "formatCurrencyCalculation_" + (sCurrency ? sCurrency + "_" + sValueFormatFromAnnotation : sValueFormatFromAnnotation);
            if (!CurrencyFormatFunctions[functionName]) {
                CurrencyFormatFunctions[functionName] = generateCurrencyFormatFunc(iNumberOfFractionalDigits, iScaleFactor, sCurrency);
            }
         ...
         * @returns {Function}
         */
        function generateCurrencyFormatFunc(iNumOfFragmentDigit, iScaleFactor, sCurrency) {
        ...
        function buildExpressionForProgressIndicatorCriticality(oInterface,
            ...
            if (oCriticalityProperty) {
                ...
                if (oCriticalityProperty.Path) {
                    ...
                    jQuery.sap.log
                        .warning("Case not supported, returning the default Neutral state");
                }
            } else {
        ...
        function resolveParameterizedEntitySet(oDataModel, oEntitySet, oSelectionVariant, aParameters, oGlobalFilter) {
            ...
            if (parameterization) {
                ...
                if (oSelectionVariant && oSelectionVariant.Parameters) {
                    ...
                    path = "/" + oEntitySet.name;
                    jQuery.sap.log.error("SelectionParameters", "There are no parameters to resolve");
                    return path;
                }
            }
