sap.ui.define(["sap/ovp/cards/generic/Card.controller", "jquery.sap.global", "sap/ui/core/ResizeHandler"],

    function (CardController, jQuery, ResizeHandler) {
        "use strict";

        return CardController.extend("sap.ovp.cards.map.GeographicalMap", {
            ...
            onAfterRendering: function () {
                ...
                this._resizeListenerId = ResizeHandler.register(this.getView().byId("oVBI"), this.onGeoCardResize.bind(this));
            },
