sap.ui.define(["sap/ovp/cards/OVPCardAsAPIUtils", "jquery.sap.global", "sap/ui/Device"],
    function (OVPCardAsAPIUtils, jQuery, Device) {
        "use strict";
        ...
        return {
            ...
            createCardComponent: function (oView, oManifest, sContainerId, oSelectionVariant) {
                return OVPCardAsAPIUtils.createCardComponent(oView, oManifest, sContainerId, oSelectionVariant);
            },
