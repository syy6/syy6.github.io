sap.ui.define(["sap/ui/core/UIComponent", "sap/ovp/cards/LoadingUtils", "sap/ui/model/json/JSONModel",
        "sap/ovp/cards/CommonUtils", "sap/ui/Device", "sap/ui/model/resource/ResourceModel",
        "sap/ui/core/mvc/ViewType", "sap/ovp/cards/AnnotationHelper", "jquery.sap.global"],

    function (UIComponent, LoadingUtils, JSONModel, CommonUtils, Device, ResourceModel, ViewType,
              AnnotationHelper, jQuery) {
        "use strict";
        ...
        return UIComponent.extend("sap.ovp.cards.generic.Component", {
            ...
            getPreprocessors: function (pOvplibResourceBundle) {
                ...
                if (oCardProperties.state && (oCardProperties.state === "Loading" || oCardProperties.state === "Error") && LoadingUtils.bPageAndCardLoading) {
