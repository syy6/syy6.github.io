sap.ui.define(["sap/ui/core/mvc/Controller", "sap/ovp/cards/ActionUtils",
        ...
        "sap/ovp/cards/loading/State", "sap/ui/generic/app/library", "jquery.sap.global", "sap/ovp/app/resources", "jquery.sap.script"],
    ...
    function (Controller, ActionUtils, SelectionVariant, PresentationVariant,
              ...
              JSONModel, Dialog, Button, MessageToast, TextDirection, LoadingState, GenericAppLibrary, jQuery, OvpResources /* jQueryScript */) {
        "use strict";
        return Controller.extend("sap.ovp.cards.generic.Card", {
            ...
            doNavigation: function (oContext, oNavigationField) {
                ...
                if (!this.oMainComponent.oAppStatePromise) {
                    fnProcessNavigation.call(this);
                } else {
                    this.oMainComponent.oAppStatePromise.then(fnProcessNavigation.bind(this));
                }
            },
            ...
            doNavigationWithUrl: function (oContext, oNavigationField) {
                ...
                if (!(oParsingSerivce.isIntentUrl(oNavigationField.url))) {
                    jQuery.sap.openWindow(oNavigationField.url, "newWindow");
                } else {
                    ...
                    this.doIntentBasedNavigation(oContext, oParsedShellHash, bWithRoute);
                }
            },
            ...
            doIntentBasedNavigation: function (oContext, oIntent, oUrlWithIntent) {
                ...
                if (oNavigationHandler) {
                    if (oIntent) {
                        oParameters = this._getEntityNavigationParameters(oEntity, oAllData); //oAllData is only for the case of custom navigation in analytical card
                        oNavArguments = {
                            target: {
                        ...
                        if (oUrlWithIntent) {
                            ...
                            oNavigationHandler.navigate(oNavArguments.target.semanticObject, oNavArguments.target.action, oNavArguments.params,
                                null, this.fnHandleError, oAppExternalData);
                        }
                    }
                }
            },
                        ...
                        if (kpiAnnotationPath && sCardType === "sap.ovp.cards.charts.analytical") {
                            ...
                            if (oDetail.RecordType === "com.sap.vocabularies.UI.v1.KPIDetailType") {
                                if (sSemanticObject && sAction) {
                                    ...
                                    jQuery.sap.log.error("Invalid Semantic object and action configured for annotation " + oDetail.RecordType);
                                }
                            }
                        }
                    }
             ...
             * @private
             */
            _getEntityNavigationParameters: function (oEntity, oCustomParameters) {
                    ...
                    if (oEntity) {
                        ...
                        for (var i = 0; oEntityType.property && i < oEntityType.property.length; i++) {
                            ...
                            if (oEntity.hasOwnProperty(key)) {
                                if (jQuery.isArray(oEntity[key]) && oEntity[key].length === 1) {
