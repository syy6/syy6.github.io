sap.ui.define(["sap/ovp/cards/generic/Card.controller", "jquery.sap.global",
        ...
        "sap/ui/core/ResizeHandler", "sap/m/MessageToast", "sap/m/Image", "sap/ovp/app/resources", "jquery.sap.script"],

    function (CardController, jQuery, OVPCardAsAPIUtils, CommonUtils, List, ResizeHandler, MessageToast, Image, OvpResources /* jQueryScript */) {
        "use strict";
        /*global sap, jQuery */
                ...
                if (OVPCardAsAPIUtils.checkIfAPIIsUsed(this)) {
                    ...
                    if (sTargetUrl) {
                        ...
                        if (sInNewWindow === "true") {
                            jQuery.sap.openWindow(sTargetUrl, "newWindow");
                        } else {
            ...
            onLinkListSemanticObjectPressLocalData: function (oEvent) {
                if (OVPCardAsAPIUtils.checkIfAPIIsUsed(this)) {
                    ...
                    if (this._oStaticContent[iRowIndex].semanticObject && this._oStaticContent[iRowIndex].action) {
                        ...
                        this.doIntentBasedNavigation(null, oIntent, false);
                    } else {
                        MessageToast.show(OvpResources.getText("Toast_Action_Error"), {
                            duration: 3000
                        });
