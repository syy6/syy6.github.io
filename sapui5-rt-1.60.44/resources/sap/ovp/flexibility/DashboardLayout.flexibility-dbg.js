sap.ui.define([
    ...
    "sap/ovp/changeHandler/RemoveCardContainer",
...
], function (HideCardContainer, UnhideCardContainer, UnhideControl, RemoveCardContainer, OverlayRegistry,
             ComponentContainer, MessageToast, SettingsConstants, SettingsUtils, OvpResources) {
    "use strict";
    return {
        "moveControls": {
        ...
        "newCardSettings": {
            changeHandler: {
                applyChange : function(oChange, oControl, mPropertyBag){
                    ...
                    if (bNewStaticLinkListCard || bNewKPICard) {
                    ...
                    setTimeout(function () {
                        ...
                        oOverLay.focus();
                        var sMessage = (bNewStaticLinkListCard || bNewKPICard) ? OvpResources.getText("OVP_KEYUSER_TOAST_MESSAGE_FOR_NEW") :
