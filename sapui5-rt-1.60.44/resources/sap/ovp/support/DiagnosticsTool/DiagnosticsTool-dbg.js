sap.ui.define([
...
], function (jQuery, Plugin, Support, DateFormat, JSONModel, MessageToast, CommonChecks, CommonMethods) {
    "use strict";
    ...
    function getMethods(oSupportStub) {
        ...
        function fnInit() {
            ...
            fnSolveConflictsForMultipleInstances(oSupportStub.isToolStub());
