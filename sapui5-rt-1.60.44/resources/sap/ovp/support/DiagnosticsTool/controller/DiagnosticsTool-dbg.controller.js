sap.ui.define([
    ...
    function fnOnCopyDataPlain() {
        ...
        //sContent += sPrefix + "Application URL: " + (sCurrentURL ? sCurrentURL : "unknown") + sNewLine;
    ...
    function fnOnCopyDataHTML() {
        ...
        var oProperties = oData.properties,						// properties to display in table
            $Anchor = jQuery.sap.byId(this.getView().byId("CopyDataHTML").getId()),
            oAnchor = $Anchor[0];
        ...
        //sContent += sPrefix + "Application URL: " + (sCurrentURL ? "<a href=\"" + sCurrentURL + "\" rel=\"noopener noreferrer\">" + sCurrentURL + "</a>" : "unknown") + sSuffix;
    ...
    function fnApplyCustomLayout() {
        ...
        if ($GroupHeaders.length === 0) {
            jQuery.sap.log.debug("No headers found which should be customized");
            return;
        }
    ...
    function fnShowDataRefreshed() {
        ...
        if (jQuery.sap.fioriElementsPluginID) {
            var $View = jQuery.sap.byId(jQuery.sap.fioriElementsPluginID);
