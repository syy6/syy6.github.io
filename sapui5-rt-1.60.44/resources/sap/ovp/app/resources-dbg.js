 ...
 */
sap.ui.define(["sap/ui/model/resource/ResourceModel", "jquery.sap.global"],
    function (ResourceModel, jQuery) {
        "use strict";
        ...
        resources.pResourcePromise.catch(function (oError) {
            jQuery.sap.log.error("sap.ovp resource library bundle error:" + oError);
        });
