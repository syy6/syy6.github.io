sap.ui.define(["sap/ovp/cards/CommonUtils", "jquery.sap.global"],
    function(CommonUtils, jQuery) {
		"use strict";
        ...
        LayoutModel.prototype._setCardSpanFromDefault = function (oCard) {
            ...
            if (!oCard.settings.defaultSpan) {
                oCard.dashboardLayout.rowSpan = oCard.template === 'sap.ovp.cards.linklist' ? 1 : 12;
