sap.ui.define(["jquery.sap.global", "sap/ovp/cards/CommonUtils", "sap/ovp/ui/UIActions",
                "sap/ui/Device", "sap/ui/core/Control", "sap/ui/core/ResizeHandler", "sap/ovp/app/resources"],
    function (jQuery, CommonUtils, UIActions, Device, Control, ResizeHandler, OvpResources) {
        "use strict";
        ...
        */
        ...
        EasyScanLayout.prototype.refreshColumnCount = function (columnCount, content, that) {
            ...
            for (var i = 0; i < columnCount; i++) {
                jqColumnsNew = jqColumnsNew.add("<div class='easyScanLayoutColumn'></div>");
            }
            var filteredItems = content.filter(function (item) {
                return item.getVisible();
            });
